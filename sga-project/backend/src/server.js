...
const startServer = () => {
    // Pega a porta do .env ou usa 5000 como padrão (conforme seu código original)
...
// const { ROLES, PERMISSIONS } = require('./constants/permissions'); // Importa ROLES e PERMISSIONS centralizados
...
// 	}),
// );
// // Pool de conexão com o banco de dados (importado do arquivo de configuração)
...
// 		console.error(
// 			`[ERRO CRÍTICO FONT] Fonte não encontrada em: ${fullPath}. O PDF não será gerado corretamente.`,
// 		);
// 		allFontsFound = false;
// 	} else {
...
// 	console.log(
// 		'[DEBUG FONT] Todas as fontes essenciais foram encontradas. Inicializando PdfPrinter.',
// 	);
// 	printer = new PdfPrinter(fonts);
// } else {
// 	console.error(
// 		'[ERRO CRÍTICO FONT] Não foi possível carregar todas as fontes necessárias. A geração de PDF pode falhar.',
// 	);
...
// 		const movementDate = new Date(details.movement_date)
// 			.toISOString()
// 			.split('T')[0];
...
// // ⚠️ ROLES foi movido para src/constants/permissions.js (importado no topo do arquivo)

// // ⚠️ PERMISSIONS foi movido para src/constants/permissions.js (importado no topo do arquivo)
...
// 	if (pcd === 'true') {
// 		conditions.push(
// 			`(s.pcd_type IS NOT NULL AND LENGTH(s.pcd_type) > 2 AND s.pcd_type NOT ILIKE 'NÃO')`,
// 		);
...
// 				message: 'Movimentação não encontrada para nomear o arquivo.',
// 			});
// 		}
...
// 	} catch (error) {
// 		console.error(
// 			'Erro ao buscar detalhes da movimentação para upload:',
// 			error,
// 		);
// 		return res
// 			.status(500)
// 			.json({ message: 'Erro interno ao preparar o upload.' });
// 	}
// };
...
// 			},
// 			{
// 				text: user.job_title || 'Cargo não informado',
// 				fontSize: 9,
// 				alignment: 'center',
// 			},
// 			{
// 				text: user.unit_name ? `Lotação: ${user.unit_name}` : '',
// 				fontSize: 9,
// 				alignment: 'center',
// 			},
// 			{
...
// 	res.status(200).json({
// 		message: `Bem-vindo, ${req.user.username}! Você acessou dados protegidos.`,
// 		user: req.user,
// 	});
// });
...
// 	'/api/users/register',
// 	authenticateToken,
// 	authorizePermission('MENU_CONFIGURACOES'),
// 	async (req, res) => {
...
// 				message: 'Campos obrigatórios: Username, Email, Nome e Perfil.',
// 			});
// 		}
...
// 		if (people.length === 0) {
// 			return res.status(404).json({
// 				message: 'Nenhuma pessoa encontrada para gerar relatório.',
// 			});
// 		}
...
// 		res.status(500).json({
// 			message: 'Erro ao gerar relatório CSV de pessoas.',
// 		});
// 	}
// });
...
// 		res.status(500).json({
// 			message: 'Erro ao gerar relatório XLSX de pessoas.',
// 		});
// 	}
// });
...
// 			content: [
// 				{
// 					text: 'Relatório de Pessoas Cadastradas',
// 					style: 'header',
// 					alignment: 'center',
// 					margin: [0, 0, 0, 20],
// 				},
...
// 						body: [
// 							['Nome Completo', 'CPF', 'Email', 'Unidade'].map(
...
// 		res.status(500).json({
// 			message: 'Erro ao gerar relatório PDF de pessoas.',
// 		});
// 	}
// });
...
// app.get(
// 	'/api/reports/audit-logs/csv',
// 	authenticateToken,
// 	authorizePermission('MENU_AUDITORIA'),
// 	async (req, res) => {
// 		try {
...
// 			}
// 			res.header('Content-Type', 'text/csv; charset=utf-8')
// 				.attachment('relatorio_auditoria.csv')
// 				.send(csvRows.join('\n'));
// 		} catch (error) {
// 			res.status(500).json({
// 				message: 'Erro ao gerar relatório CSV de auditoria.',
// 			});
// 		}
// 	},
// );
...
// 				'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
// 			)
// 				.attachment('relatorio_auditoria.xlsx')
// 				.send(buffer);
// 		} catch (error) {
// 			res.status(500).json({
// 				message: 'Erro ao gerar relatório XLSX de auditoria.',
// 			});
// 		}
// 	},
// );
...
// 				content: [
// 					{
// 						text: 'Relatório de Auditoria do Sistema',
// 						style: 'header',
// 						alignment: 'center',
// 						margin: [0, 0, 0, 20],
// 					},
...
// 					.attachment('relatorio_auditoria.pdf')
// 					.send(Buffer.concat(chunks)),
// 			);
// 			pdfDoc.end();
// 		} catch (error) {
// 			res.status(500).json({
// 				message: 'Erro ao gerar relatório PDF de auditoria.',
// 			});
// 		}
// 	},
// );
...
// 	const result = await pool.query(
// 		'SELECT code, name, type, address, contact_phone, rpa FROM units ORDER BY type, name',
// 	);
// 	return result.rows;
// };
...
// 	} catch (error) {
// 		res.status(500).json({
// 			message: 'Erro ao gerar relatório CSV de unidades.',
// 		});
// 	}
// });
...
// 	} catch (error) {
// 		res.status(500).json({
// 			message: 'Erro ao gerar relatório XLSX de unidades.',
// 		});
// 	}
// });
...
// 		if (units.length === 0) {
// 			return res.status(404).json({
// 				message: 'Nenhuma unidade encontrada para gerar relatório.',
// 			});
// 		}
...
// 			content: [
// 				{
// 					text: 'Relatório de Unidades Cadastradas',
// 					style: 'header',
// 					alignment: 'center',
// 					margin: [0, 0, 0, 20],
// 				},
...
// 	} catch (error) {
// 		res.status(500).json({
// 			message: 'Erro ao gerar relatório PDF de unidades.',
// 		});
// 	}
// });
...
// 	const result = await pool.query(
// 		'SELECT code, name, description FROM item_types ORDER BY name',
// 	);
// 	return result.rows;
// };
...
// 	} catch (error) {
// 		res.status(500).json({
// 			message: 'Erro ao gerar relatório CSV de tipos de itens.',
// 		});
// 	}
// });
...
// 	} catch (error) {
// 		res.status(500).json({
// 			message: 'Erro ao gerar relatório XLSX de tipos de itens.',
// 		});
// 	}
// });
...
// 			return res.status(404).json({
// 				message: 'Nenhum tipo de item encontrado para gerar relatório.',
// 			});
// 		}
...
// 			content: [
// 				{
// 					text: 'Relatório de Tipos de Itens',
// 					style: 'header',
// 					alignment: 'center',
// 					margin: [0, 0, 0, 20],
// 				},
...
// 				},
// 				{
// 					text: `\nTotal de Tipos de Itens: ${itemTypes.length}`,
// 					alignment: 'right',
// 					style: 'footer',
// 				},
// 			],
...
// 	} catch (error) {
// 		res.status(500).json({
// 			message: 'Erro ao gerar relatório PDF de tipos de itens.',
// 		});
// 	}
// });
...
// 		try {
// 			const result = await pool.query(
// 				'SELECT id, username, email, full_name, role, created_at, is_active FROM users ORDER BY full_name ASC',
// 			);
// 			res.status(200).json(result.rows);
// 		} catch (error) {
...
// 			movementsResult.rows.map(async (movement) => {
...
// 		await logAudit(
// 			req.user.id,
// 			'list_confirmed_receipts',
// 			'asset_movement',
// 			null,
// 			{ count: movementsWithDetails.length },
// 			ipAddress,
// 		);
...
// app.get(
// 	'/api/receipts/:movementId/download',
// 	authenticateToken,
// 	async (req, res) => {
...
// 				return res.status(404).json({
// 					message:
// 						'Recibo assinado não encontrado para esta movimentação.',
// 				});
// 			}
...
// 				return res.status(404).json({
// 					message:
// 						'O arquivo do recibo não foi encontrado no servidor.',
// 				});
// 			}
...
// 				'user',
// 				userIdToDelete,
// 				{ reason: 'Admin tried to delete self' },
// 				ipAddress,
// 			);
// 			return res.status(403).json({
// 				message:
...
// 			);
// 			res.status(500).json({
// 				message: 'Erro interno do servidor ao remover usuário.',
// 			});
// 		} finally {
...
// 			return res.status(400).json({
// 				message:
// 					'Todos os campos, incluindo o status de ativação, são obrigatórios.',
// 			});
// 		}
...
// 					message:
// 						'O username ou email já está em uso por outra conta.',
// 				});
// 			}
// 			await logAudit(
// 				req.user.id,
...
// 			// Exemplo de regra de complexidade
// 			return res.status(400).json({
...
// 		whereClauses.push(
// 			`(a.patrimonio_number ILIKE $${queryParams.length} OR a.serial_number ILIKE $${queryParams.length})`,
// 		);
// 	}
...
// 	const movementsWithAssets = await Promise.all(
...
// 		if (!name || !sku_code) {
// 			return res.status(400).json({
// 				message: 'Nome e Código SKU (3 letras) são obrigatórios.',
// 			});
// 		}
// 		if (String(sku_code).length !== 3) {
// 			return res.status(400).json({
// 				message: 'O Código SKU deve ter exatamente 3 caracteres.',
// 			});
// 		}

// 		try {
// 			// Lógica para gerar o código principal (ex: SEDUC001)
// 			const lastItemType = await pool.query(
// 				'SELECT code FROM item_types ORDER BY id DESC LIMIT 1',
// 			);
// 			let newCodeNum = 1;
...
// 				'create_item_type',
// 				'item_type',
// 				newItemType.rows[0].id,
// 				{ name, code, sku_code },
// 				ipAddress,
// 			);
// 			res.status(201).json({
// 				message: 'Tipo de item criado com sucesso.',
// 				itemType: newItemType.rows[0],
// 			});
// 		} catch (error) {
...
// 					return res.status(400).json({
// 						message: `O Código SKU '${sku_code.toUpperCase()}' já está em uso por outro item. Utilize uma variação (ex: SW8, S24).`,
// 					});
// 				}
// 				// Verifica se a violação foi no nome
// 				if (error.constraint && error.constraint.includes('name')) {
// 					return res.status(400).json({
// 						message: `O nome '${name}' já está cadastrado.`,
// 					});
// 				}

// 				// Fallback caso não identifique a coluna
// 				return res.status(400).json({
// 					message: 'Já existe um item com este Nome ou SKU.',
// 				});
// 			}
...
// 		);
// 		res.status(500).json({
// 			message: 'Erro interno do servidor ao listar tipos de itens.',
// 		});
// 	}
// });
...
// 			return res
// 				.status(404)
// 				.json({ message: 'Tipo de item não encontrado.' });
// 		}
...
// 		);
// 		res.status(500).json({
// 			message: 'Erro interno do servidor ao obter tipo de item.',
// 		});
// 	}
// });
...
// 		try {
// 			const oldItemTypeResult = await pool.query(
// 				'SELECT * FROM item_types WHERE id = $1',
// 				[id],
// 			);
// 			if (oldItemTypeResult.rows.length === 0) {
// 				return res.status(404).json({
// 					message: 'Tipo de item não encontrado para atualização.',
// 				});
// 			}
...
// 				'item_type',
// 				id,
// 				{ old_data: oldItemType, new_data: updatedItemType.rows[0] },
// 				ipAddress,
// 			);
// 			res.status(200).json({
// 				message: 'Tipo de item atualizado com sucesso.',
// 				itemType: updatedItemType.rows[0],
// 			});
// 		} catch (error) {
...
// 				return res.status(409).json({
// 					message:
// 						'Tipo de item com este nome ou Código SKU já existe.',
// 				});
// 			}
// 			res.status(500).json({
// 				message: 'Erro interno do servidor ao atualizar tipo de item.',
// 			});
// 		}
// 	},
// );
...
// 				'SELECT COUNT(*) FROM assets WHERE item_type_id = $1',
// 				[id],
// 			);
// 			if (parseInt(assetsCount.rows[0].count, 10) > 0) {
// 				return res.status(400).json({
// 					message:
// 						'Não é possível deletar este tipo de item, pois existem ativos associados a ele.',
// 				});
// 			}

// 			const deletedItemType = await pool.query(
// 				'DELETE FROM item_types WHERE id = $1 RETURNING *',
// 				[id],
// 			);
// 			if (deletedItemType.rows.length === 0) {
// 				return res.status(404).json({
// 					message: 'Tipo de item não encontrado para exclusão.',
// 				});
// 			}
...
// 				'item_type',
// 				id,
// 				{ deleted_item_type: deletedItemType.rows[0] },
// 				ipAddress,
// 			);
// 			res.status(200).json({
...
// 			);
// 			res.status(500).json({
// 				message: 'Erro interno do servidor ao deletar tipo de item.',
// 			});
// 		}
// 	},
// );
...
// 		res.status(500).json({
// 			message: 'Erro interno do servidor ao listar unidades.',
// 		});
// 	}
// });
...
// 			notes,
// 			rpa,
// 		} = req.body; // <--- Adicionado rpa
// 		const ipAddress = req.ip;

// 		if (!type || !name) {
// 			return res
// 				.status(400)
// 				.json({ message: 'Tipo e Nome da unidade são obrigatórios.' });
// 		}
...
// 			if (error.code === '23505') {
// 				// Erro de violação de unique (código ou nome)
// 				return res.status(409).json({
// 					message: 'Já existe uma unidade com este nome ou código.',
// 				});
// 			}
// 			res.status(500).json({
...
// 		const parent_id =
// 			parentIdFromRequest ? parseInt(parentIdFromRequest, 10) : null;

// 		if (!name || !status || !type) {
// 			return res
// 				.status(400)
// 				.json({ message: 'Nome, Status e Tipo são obrigatórios.' });
// 		}
...
// 				return res
// 					.status(400)
// 					.json({ message: 'ID de unidade inválido.' });
// 			}
...
// 					return res.status(409).json({
// 						message:
// 							'Já existe outra unidade com este Código/Sigla.',
// 					});
// 				}
// 			}
...
// 				return res.status(409).json({
// 					message:
// 						'Já existe outra unidade com este nome na mesma hierarquia.',
// 				});
// 			}
...
// 				'unit',
// 				id,
// 				{ updated_data: updatedUnit.rows[0] },
// 				ipAddress,
// 			);
// 			res.status(200).json({
...
// 			const childUnitsCount = await pool.query(
// 				'SELECT COUNT(*) FROM units WHERE parent_id = $1',
// 				[id],
// 			);
// 			if (parseInt(childUnitsCount.rows[0].count, 10) > 0) {
// 				return res.status(400).json({
// 					message:
// 						'Não é possível deletar esta unidade, pois ela é uma unidade superior para outra(s). Remova ou realoque as unidades filhas primeiro.',
// 				});
// 			}
...
// 				return res
// 					.status(404)
// 					.json({ message: 'Unidade não encontrada para exclusão.' });
// 			}
...
// 				'unit',
// 				id,
// 				{ deleted_unit: deletedUnit.rows[0] },
// 				ipAddress,
// 			);
...
// 			res.status(500).json({
// 				message: 'Erro interno do servidor ao deletar unidade.',
// 			});
// 		}
// 	},
// );
...
// 			return res.status(400).json({
// 				message: 'Nome Completo, CPF e Email são obrigatórios.',
// 			});
// 		}
...
// 					null,
// 					{
// 						reason: 'CPF, Registration Number or Email already exists',
// 						attempted_cpf: cpf,
// 						attempted_registration: registration_number,
...
// 				return res.status(409).json({
// 					message:
// 						'Pessoa com este CPF, Matrícula ou Email já cadastrada.',
// 				});
// 			}
...
// 			res.status(500).json({
// 				message: 'Erro interno do servidor ao cadastrar pessoa.',
// 			});
// 		}
// 	},
// );
...
// 		);
// 		res.status(500).json({
// 			message: 'Erro interno do servidor ao listar pessoas.',
// 		});
// 	}
// });
...
// 		);
// 		res.status(500).json({
// 			message: 'Erro interno do servidor ao obter pessoa.',
// 		});
// 	}
// });
...
// 		try {
// 			const oldPersonResult = await pool.query(
...
// 					id,
// 					{
// 						reason: 'CPF, Registration Number or Email already exists for another person',
// 						attempted_cpf: cpf,
// 						attempted_registration: registration_number,
// 						attempted_email: email,
// 					},
...
// 				return res.status(409).json({
// 					message:
// 						'Pessoa com este CPF, Matrícula ou Email já existe para outro cadastro.',
// 				});
// 			}
...
// 				'person',
// 				id,
// 				{ old_data: oldPerson, new_data: updatedPerson.rows[0] },
// 				ipAddress,
// 			);
// 			res.status(200).json({
...
// 			if (error.code === '23505') {
// 				// Unique violation for CPF, registration_number or email
// 				return res.status(409).json({
// 					message:
// 						'CPF, Matrícula ou Email já existe para outra pessoa.',
// 				});
// 			}
// 			await logAudit(
// 				req.user.id,
...
// 				'person',
// 				id,
// 				{ error: error.message, full_name, cpf, email },
// 				ipAddress,
// 			);
// 			res.status(500).json({
// 				message: 'Erro interno do servidor ao atualizar pessoa.',
// 			});
// 		}
// 	},
// );
...
// 				'SELECT COUNT(*) FROM asset_movements WHERE recipient_person_id = $1',
// 				[id],
// 			);
// 			if (parseInt(movementsCount.rows[0].count, 10) > 0) {
// 				return res.status(400).json({
// 					message:
// 						'Não é possível deletar esta pessoa, pois existem movimentações de ativos associadas a ela.',
// 				});
// 			}
...
// 				return res
// 					.status(404)
// 					.json({ message: 'Pessoa não encontrada para exclusão.' });
// 			}
...
// 				'person',
// 				id,
// 				{ deleted_person: deletedPerson.rows[0] },
// 				ipAddress,
// 			);
...
// 			);
// 			res.status(500).json({
// 				message: 'Erro interno do servidor ao deletar pessoa.',
// 			});
// 		}
// 	},
// );
...
// app.put(
// 	'/api/assets/batch-retire',
// 	authenticateToken,
// 	authorizePermission('ACTION_REQUEST_RETIREMENT'),
// 	async (req, res) => {
...
// 			return res.status(400).json({
// 				message: 'É necessário fornecer uma lista de IDs de ativos.',
// 			});
// 		}
// 		if (!reason) {
// 			return res
// 				.status(400)
// 				.json({ message: 'O motivo da baixa é obrigatório.' });
// 		}
...
// 					'SELECT id, status, notes, patrimonio_number FROM assets WHERE id = $1',
// 					[assetId],
// 				);
...
// 						reason: `Status atual é '${asset.status}', não pode ser baixado.`,
// 					});
// 					continue;
// 				}
...
// 			res.status(500).json({
// 				message: `Erro ao processar a baixa em lote: ${error.message}`,
// 			});
// 		} finally {
// 			client.release();
// 		}
...
// 		if (!req.file)
// 			return res.status(400).json({
// 				message: 'O arquivo de evidência (laudo/B.O.) é obrigatório.',
// 			});
// 		if (!reason) {
...
// 				throw new Error(
// 					`Ativos com status '${currentStatus}' não podem ter a baixa solicitada.`,
// 				);
// 			}
...
// 				'asset',
// 				assetId,
// 				{ requestId: newRequestId, type: retirement_type },
// 				ipAddress,
// 			);
...
// app.get(
// 	'/api/retirement-requests/pending',
// 	authenticateToken,
// 	authorizePermission('ACTION_CREATE_EDIT'),
// 	async (req, res) => {
// 		try {
...
// 		} catch (error) {
// 			console.error(
// 				'[ERRO CRÍTICO] Falha ao listar solicitações:',
// 				error.message,
// 			);
// 			// Retorna o erro detalhado para o frontend (útil para debug agora)
// 			res.status(500).json({
// 				message: 'Erro interno ao buscar lista: ' + error.message,
// 			});
// 		}
// 	},
// );
...
// app.put(
// 	'/api/retirement-requests/:id/approve',
// 	authenticateToken,
// 	authorizePermission('ACTION_FINAL_APPROVAL'),
// 	async (req, res) => {
...
// 			const requestResult = await client.query(
// 				'SELECT asset_id, status FROM retirement_requests WHERE id = $1',
// 				[requestId],
// 			);
...
// 			);
// 			res.status(200).json({
// 				message: 'Solicitação de baixa APROVADA com sucesso.',
// 			});
// 		} catch (error) {
// 			await client.query('ROLLBACK');
...
// 			res.status(500).json({
// 				message: `Falha na aprovação: ${errorMessage}`,
// 			});
// 		} finally {
// 			client.release();
// 		}
...
// app.put(
// 	'/api/retirement-requests/:id/reject',
// 	authenticateToken,
// 	authorizePermission('ACTION_FINAL_APPROVAL'),
// 	async (req, res) => {
// 		const requestId = parseInt(req.params.id, 10);
...
// 			return res
// 				.status(400)
// 				.json({ message: 'O motivo da rejeição é obrigatório.' });
// 		}
...
// 				'asset',
// 				assetId,
// 				{ requestId, rejection_reason },
// 				ipAddress,
// 			);
// 			res.status(200).json({
// 				message: 'Solicitação de baixa REJEITADA com sucesso.',
// 			});
// 		} catch (error) {
// 			await client.query('ROLLBACK');
...
// 				error instanceof Error ? error.message : 'Erro desconhecido.';
// 			res.status(500).json({
// 				message: `Falha na rejeição: ${errorMessage}`,
// 			});
// 		} finally {
// 			client.release();
// 		}
...
// 		if (assetResult.rows.length === 0) {
// 			return res.status(404).json({
// 				message: 'Ativo não encontrado com este identificador.',
// 			});
// 		}
...
// 				assetDetails.responsible_person_name =
// 					responsibleResult.rows[0].full_name;
// 			} else {
// 				assetDetails.responsible_person_name =
// 					'Responsável não localizado no histórico';
// 			}
// 		}
...
// 	} catch (error) {
// 		console.error(
// 			`Erro na consulta inteligente do ativo ${identifier}:`,
// 			error,
// 		);
// 		res.status(500).json({
// 			message: 'Erro interno do servidor ao consultar ativo.',
// 		});
// 	}
// });
...
// app.get(
// 	'/api/retirement-requests/:id/download-evidence',
// 	authenticateToken,
// 	authorizePermission('ACTION_CREATE_EDIT'),
// 	async (req, res) => {
// 		const requestId = parseInt(req.params.id, 10);
// 		try {
// 			const result = await pool.query(
// 				'SELECT evidence_path FROM retirement_requests WHERE id = $1',
// 				[requestId],
// 			);
// 			if (result.rows.length === 0 || !result.rows[0].evidence_path) {
// 				return res.status(404).json({
// 					message:
// 						'Arquivo de evidência não encontrado para esta solicitação.',
// 				});
// 			}
...
// 		res.status(500).json({
// 			message: 'Erro interno do servidor ao buscar ativos da pessoa.',
// 		});
// 	}
// });
...
// 		} catch (error) {
// 			console.error(
// 				`Erro ao buscar resumo de ativos para a pessoa ${personId}:`,
// 				error,
// 			);
// 			res.status(500).json({ message: 'Erro interno do servidor.' });
// 		}
...
// 	if (!identifier) {
// 		return res.status(400).json({
// 			message: 'Identificador (patrimônio ou nº de série) é obrigatório.',
// 		});
// 	}
...
// 			return res.status(409).json({
// 				message: `Este ativo não pode ser devolvido. Status atual: '${asset.status}'.`,
// 			});
// 		}
...
// 			return res.status(404).json({
// 				message:
// 					'Não foi possível encontrar o responsável atual por este ativo.',
// 			});
// 		}
...
// 			return res.status(404).json({
// 				message:
// 					'O ativo foi movimentado, mas não há um responsável (pessoa) vinculado à última saída.',
// 			});
// 		}
...
// 			return res.status(404).json({
// 				message: 'Cadastro do responsável pelo ativo não encontrado.',
// 			});
// 		}
...
// 			return res
// 				.status(400)
// 				.json({ message: 'O número de patrimônio é obrigatório.' });
// 		}
...
// 					throw new Error(
// 						'Este ativo consta como DESCARTADO e não pode ser devolvido.',
// 					);
// 				}

// 				// Atualiza status baseado na condição informada
// 				const newStatus =
// 					condition === 'Ruim' || condition === 'Defeito' ?
// 						'maintenance'
// 					:	'available';
...
// 				isLegacy = true;
// 				console.log(
// 					`[DEVOLUÇÃO] Ativo ${cleanPatrimonio} não encontrado. Criando registro legado.`,
// 				);

// 				// Busca o ID do tipo 'Tablet'
// 				const typeRes = await client.query(
// 					"SELECT id, sku_code FROM item_types WHERE name ILIKE '%Tablet%' LIMIT 1",
// 				);
// 				if (typeRes.rows.length === 0)
// 					throw new Error('Tipo "Tablet" não cadastrado no sistema.');
...
// 			await logAudit(
// 				userId,
// 				isLegacy ? 'return_legacy_created' : 'return_manual',
// 				'asset',
// 				assetId,
...
// 				if (!full_name || !cpf || !email) {
// 					errors.push(
// 						`Linha ${line}: Ignorada. Nome completo, CPF e E-mail são obrigatórios.`,
// 					);
// 					continue;
// 				}
...
// 						'SELECT id FROM people WHERE cpf = $1 OR email = $2',
// 						[cpf, email],
// 					);
// 					if (existingPerson.rows.length > 0) {
// 						errors.push(
// 							`Linha ${line}: Pessoa com CPF '${cpf}' ou E-mail '${email}' já existe. Ignorada.`,
// 						);
// 						await client.query('ROLLBACK');
// 						continue;
// 					}
...
// 							errors.push(
// 								`Linha ${line}: Unidade '${unit_name}' não encontrada. A pessoa será cadastrada sem unidade.`,
// 							);
// 						}
// 					}
...
// 					await client.query('ROLLBACK');
// 					console.error(
// 						'Erro ao importar pessoa da linha:',
// 						row,
// 						dbError,
// 					);
// 					errors.push(
// 						`Linha ${line}: Erro no banco de dados ao importar '${full_name}': ${dbError.message}`,
// 					);
// 				} finally {
// 					client.release();
// 				}
...
// 			);
// 			res.status(500).json({
// 				message: 'Erro interno do servidor ao importar pessoas.',
// 				error: error.message,
// 			});
// 		}
// 	},
...
// 		const safePatrimonio =
// 			patrimonio_number ? String(patrimonio_number).trim() : null;
...
// 			return res.status(400).json({
// 				message:
// 					'Tipo de Item, Marca, Modelo e Status são obrigatórios.',
// 			});
// 		}
// 		// ----------------------------------
...
// 				'SELECT sku_code FROM item_types WHERE id = $1',
// 				[item_type_id],
// 			);
...
// 			if (error.code === '23505') {
// 				if (error.constraint && error.constraint.includes('patrimonio'))
// 					return res.status(409).json({
// 						message: 'Já existe um ativo com este Patrimônio.',
// 					});
// 				if (error.constraint && error.constraint.includes('serial'))
// 					return res.status(409).json({
// 						message: 'Já existe um ativo com este Serial.',
// 					});
// 				return res
// 					.status(409)
// 					.json({ message: 'Conflito de dados duplicados.' });
// 			}
...
// 					'asset',
// 					null,
// 					{ error: error.message, brand, model },
// 					ipAddress,
// 				);
// 			} catch (auditErr) {
// 				console.error('Falha ao logar erro:', auditErr);
// 			}

// 			res.status(500).json({
// 				message: 'Erro interno do servidor ao criar ativo.',
// 			});
// 		} finally {
// 			client.release();
// 		}
...
// 		);
// 		res.status(500).json({
// 			message: 'Erro interno do servidor ao listar ativos.',
// 		});
// 	}
// });
...
// 		return res
// 			.status(400)
// 			.json({ message: 'Digite pelo menos 3 caracteres.' });
// 	}
...
// app.get(
// 	'/api/assets/validate-returnable',
// 	authenticateToken,
// 	async (req, res) => {
...
// 			return res
// 				.status(400)
// 				.json({ message: 'Informe o patrimônio ou serial.' });
// 		}
...
// 				return res.status(404).json({
// 					message: 'Ativo não encontrado no banco de dados.',
// 				});
// 			} else {
...
// 				if (status === 'available')
// 					msg = 'Este item já consta como Disponível no estoque.';
// 				if (status === 'retired')
// 					msg = 'Este item já foi Baixado/Descartado.';
// 				if (status === 'maintenance')
// 					msg = 'Este item já está em Manutenção.';
...
// 		);
// 		res.status(500).json({
// 			message: 'Erro interno do servidor ao obter ativo.',
// 		});
// 	}
// });
...
// 					parsedDate = new Date(
// 						Math.round((numericDate - 25569) * 86400 * 1000),
// 					);
// 				} else {
...
// 				parsedDate = new Date(
// 					Math.round((dateInput - 25569) * 86400 * 1000),
// 				);
// 			}
...
// 					const typeName =
// 						row['item_type_name'] || row['Tipo'] || row['tipo'];
...
// 					let rawPatrimonio =
// 						row['patrimonio_number'] || row['Patrimônio'];
// 					const patrimonio_number =
// 						row['patrimonio_number'] || row['Patrimônio'] || null;
// 					const unit_name =
// 						row['unit_name'] || row['Unidade'] || null;
// 					let status = row['status'] || 'available';

// 					// Datas
// 					const acquisition_date =
// 						row['acquisition_date'] || row['Data Aquisição'];
// 					const warranty_end_date =
// 						row['warranty_end_date'] || row['Fim Garantia'];

// 					// Validação de campos obrigatórios
// 					if (!typeName || !brand || !model) {
// 						errors.push(
// 							`Linha ${line}: Ignorada. 'Tipo', 'Marca' e 'Modelo' são obrigatórios.`,
// 						);
// 						continue;
// 					}
...
// 						parseAndFormatDate(acquisition_date);
// 					const formattedWarrantyEndDate =
// 						parseAndFormatDate(warranty_end_date);

// 					if (
// 						formattedAcquisitionDate === 'invalid' ||
// 						formattedWarrantyEndDate === 'invalid'
// 					) {
...
// 							errors.push(
// 								`Linha ${line}: Patrimônio '${patrimonio_number}' ou Série '${serial_number}' já existe. Ignorado.`,
// 							);
// 							await client.query('ROLLBACK');
// 							continue;
// 						}
...
// 						if (!typeData) {
// 							const typeRes = await client.query(
// 								'SELECT id, sku_code FROM item_types WHERE name ILIKE $1',
// 								[typeName],
// 							);

// 							if (typeRes.rows.length === 0) {
// 								errors.push(
// 									`Linha ${line}: Tipo de item '${typeName}' não encontrado no sistema. Cadastre-o antes.`,
// 								);
// 								await client.query('ROLLBACK');
// 								continue;
// 							}
...
// 						if (unit_name) {
// 							const unitResult = await client.query(
// 								'SELECT id FROM units WHERE name ILIKE $1',
// 								[unit_name],
// 							);
// 							if (unitResult.rows.length > 0) {
...
// 							errors.push(
// 								`Linha ${line}: Dados duplicados (SKU, Serial ou Patrimônio).`,
// 							);
// 						} else {
// 							errors.push(
// 								`Linha ${line}: Erro no banco - ${dbError.message}`,
// 							);
// 						}
// 					}
// 				}
...
// 				'asset',
// 				null,
// 				{ imported_count: importedCount, errors_count: errors.length },
// 				ipAddress,
// 			);
...
// 			);
// 			res.status(500).json({
// 				message: 'Erro interno do servidor ao importar ativos.',
// 				error: error.message,
// 			});
// 		}
// 	},
...
// app.get(
// 	'/api/assets/by-patrimonio/:patrimonio_number',
// 	authenticateToken,
// 	async (req, res) => {
...
// 				return res.status(404).json({
// 					message:
// 						'Ativo não encontrado com este número de patrimônio.',
// 				});
// 			}
// 			res.status(200).json(result.rows[0]);
// 		} catch (error) {
// 			console.error(
// 				'Erro ao obter ativo por número de patrimônio:',
// 				error,
// 			);
// 			await logAudit(
// 				req.user.id,
// 				'get_asset_by_patrimonio_error',
// 				'asset',
// 				null,
// 				{ error: error.message, patrimonio_number },
// 				req.ip,
// 			);
// 			res.status(500).json({
// 				message:
// 					'Erro interno do servidor ao buscar ativo por número de patrimônio.',
// 			});
// 		}
// 	},
// );
...
// app.post(
// 	'/api/assets/validate-for-movement',
// 	authenticateToken,
// 	async (req, res) => {
...
// 			return res.status(400).json({
// 				message: 'Número de patrimônio e tipo são obrigatórios.',
// 			});
// 		}
...
// 		try {
// 			const cleanPatrimonio = String(patrimonio_number).replace(
// 				/\D/g,
// 				'',
// 			);
...
// 				return res
// 					.status(404)
// 					.json({ message: 'Ativo não encontrado.' });
// 			}
...
// 			const statusPT =
// 				statusTranslation[currentAssetStatus] || currentAssetStatus;

// 			// >>> VALIDAÇÃO DE BLOQUEIOS (BAIXA/DESCARTE) <<<
// 			if (currentAssetStatus === 'pending_retirement') {
// 				return res.status(409).json({
// 					message: `Este ativo está bloqueado: ${statusPT}.`,
// 				});
// 			}

// 			if (['retired', 'disposed'].includes(currentAssetStatus)) {
// 				return res.status(409).json({
// 					message: `Operação negada. O ativo consta como: ${statusPT}.`,
// 				});
// 			}
...
// 				return res.status(404).json({
// 					message: 'Ativo não encontrado para atualização.',
// 				});
// 			}
...
// 				'asset',
// 				id,
// 				{ old_data: oldAsset, new_data: updatedAsset.rows[0] },
// 				ipAddress,
// 			);
// 			res.status(200).json({
...
// 				return res.status(409).json({
// 					message:
// 						'Número de série, número de patrimônio ou SKU já existe para outro ativo.',
// 				});
// 			}
// 			await logAudit(
// 				req.user.id,
...
// 			);
// 			res.status(500).json({
// 				message: 'Erro interno do servidor ao atualizar ativo.',
// 			});
// 		}
// 	},
// );
...
// 			const movementsCount = await pool.query(
// 				'SELECT COUNT(*) FROM movement_assets WHERE asset_id = $1',
// 				[id],
// 			); // Alterado para movement_assets
// 			if (parseInt(movementsCount.rows[0].count, 10) > 0) {
// 				return res.status(400).json({
// 					message:
// 						'Não é possível deletar este ativo, pois existem movimentações registradas para ele.',
// 				});
// 			}
...
// 				return res
// 					.status(404)
// 					.json({ message: 'Ativo não encontrado para exclusão.' });
// 			}
...
// 				'asset',
// 				id,
// 				{ deleted_asset: deletedAsset.rows[0] },
// 				ipAddress,
// 			);
...
// 			);
// 			res.status(500).json({
// 				message: 'Erro interno do servidor ao deletar ativo.',
// 			});
// 		}
// 	},
// );
...
// 				"SELECT id, code FROM units WHERE type = 'ESCOLAR' AND code IS NOT NULL",
// 			);
// 			const unitMap = new Map();
// 			unitsRes.rows.forEach((u) =>
// 				unitMap.set(String(u.code).trim(), u.id),
// 			);
...
// 						row['nome'];
// 					const INEP =
// 						row['INEP'] || row['Inep'] || row['CODIGO_INEP'];
// 					const ESCOLA_NOME =
// 						row['ESCOLA'] || row['Escola'] || row['NOME_ESCOLA']; // Precisamos do nome caso tenhamos que criar
...
// 						errors.push(
// 							`Linha ${line}: Ignorada. Matrícula ou Nome do aluno faltando.`,
// 						);
// 						continue;
// 					}
...
// 					if (!INEP) {
// 						errors.push(
// 							`Linha ${line}: Ignorada. Código INEP da escola faltando.`,
// 						);
// 						continue;
// 					}
...
// 						const newSchoolName =
// 							ESCOLA_NOME || `Escola INEP ${cleanInep}`; // Fallback se não tiver nome
// 						const cleanRpa =
// 							RPA ? String(RPA).replace(/\D/g, '') : null;

// 						console.log(
// 							`[IMPORT] Criando nova escola automaticamente: ${newSchoolName} (${cleanInep})`,
// 						);
...
// 						if (
// 							pcdText.length > 0 &&
// 							!invalidValues.includes(pcdText)
// 						) {
// 							requires_livox = true;
// 						}
// 					}
...
// 					if (result.rows[0].xmax === '0') importedCount++;
// 					else updatedCount++;
...
// 			await logAudit(
// 				req.user.id,
// 				'import_tablet_students',
// 				'tablet_eligible_students',
// 				null,
// 				{
// 					imported: importedCount,
// 					updated: updatedCount,
// 					new_schools: newSchoolsCount,
...
// 				schoolsCreated:
// 					newSchoolsCount > 0 ?
// 						`${newSchoolsCount} novas escolas cadastradas automaticamente.`
// 					:	null,
// 				errors,
// 			});
// 		} catch (error) {
...
// // =====================================================================
// app.get(
// 	'/api/dashboard/tablets/metrics',
// 	authenticateToken,
// 	authorizePermission('MENU_ESCOLAR'),
// 	async (req, res) => {
// 		try {
// 			// Pega o construtor de filtros que já existia no seu código
// 			const { whereClause, values } = buildDashboardFilters(req.query);

// 			// 1. Totais Gerais
// 			const totalRes = await pool.query(
// 				`SELECT COUNT(*) FROM tablet_eligible_students s WHERE 1=1 ${whereClause}`,
// 				values,
// 			);
...
// 			// >>> CORREÇÃO 1: PENDENTES GERAIS (Ignora os Devolvidos) <<<
...
// 			// >>> CORREÇÃO 2: A PENDÊNCIA LIVOX (O FANTASMA MORRE AQUI) <<<
...
// 			// >>> CORREÇÃO 3: ESCOLAS PENDENTES (As resolvidas saem da lista) <<<
...
// 			// =========================================================
// 			const totalLivoxRes = await pool.query(
// 				`SELECT COUNT(*) FROM assets WHERE has_livox = TRUE AND status NOT IN ('retired', 'disposed', 'missing')`,
// 			);
// 			const totalLivox = parseInt(totalLivoxRes.rows[0].count);

// 			const availableLivoxRes = await pool.query(
// 				`SELECT COUNT(*) FROM assets WHERE has_livox = TRUE AND status = 'available'`,
// 			);
...
//         -- >>> CORREÇÃO AQUI: < CURRENT_DATE (Só é atraso no dia seguinte)
...
//         -- >>> CORREÇÃO AQUI TAMBÉM: < CURRENT_DATE para ordenar os atrasados primeiro
...
// 					total,
// 					delivered,
// 					// Usa a variável que calcula os reais pendentes (ignorando os devolvidos)
...
// 					percentagePcd:
// 						totalPcd > 0 ?
// 							((allocatedPcd / totalPcd) * 100).toFixed(1)
// 						:	0,
// 				},
...
// // =====================================================================
// app.get(
// 	'/api/delivery-batches/:id/signed-receipt',
// 	authenticateToken,
// 	async (req, res) => {
// 		const { id } = req.params;
...
// 			const result = await pool.query(
// 				'SELECT collective_receipt_path FROM delivery_batches WHERE id = $1',
// 				[id],
// 			);
...
// 				return res
// 					.status(404)
// 					.json({ message: 'Lote não encontrado.' });
// 			}
...
// 			if (!filePath) {
// 				return res.status(404).json({
// 					message: 'Nenhum recibo assinado foi anexado a este lote.',
// 				});
// 			}
...
// // =====================================================================
// app.post(
// 	'/api/tablets/complementary-batch',
// 	authenticateToken,
// 	authorizePermission('MENU_ESCOLAR'),
// 	async (req, res) => {
...
// 			return res.status(400).json({
// 				message: 'Escola e lista de alunos são obrigatórios.',
// 			});
// 		}
...
// 				'SELECT name, rpa FROM units WHERE id = $1',
// 				[school_unit_id],
// 			);
...
// 				throw new Error(
// 					`Estoque insuficiente. Necessário: ${students.length}, Disponível: ${availableAssets.length}`,
// 				);
// 			}
...
// 					sData.pcd &&
// 					sData.pcd.length > 2 &&
// 					!['NÃO', 'NAO'].includes(sData.pcd.toUpperCase())
// 				)
// 					requires_livox = true;
...
// 					throw new Error(
// 						`O aluno ${sData.name} (${sData.registration}) já possui um tablet registrado.`,
// 					);
// 				}
...
// 			await logAudit(
// 				user_id,
// 				'create_complementary_batch',
// 				'delivery_batches',
// 				batchId,
// 				{ count: students.length, scheduled_date },
// 				ipAddress,
// 			);

// 			res.json({
// 				message: 'Lote complementar criado com sucesso!',
// 				batchId,
// 			});
// 		} catch (error) {
// 			await client.query('ROLLBACK');
...
// // =====================================================================
// app.post(
// 	'/api/delivery-batches/:id/add-manual-student',
// 	authenticateToken,
// 	authorizePermission('MENU_ESCOLAR'),
// 	async (req, res) => {
...
// 			if (
// 				pcd_type &&
// 				String(pcd_type).length > 2 &&
// 				!['NÃO', 'NAO'].includes(String(pcd_type).toUpperCase())
// 			) {
// 				requires_livox = true;
// 			}
...
// 			if (checkDouble.rows.length > 0) {
// 				throw new Error(
// 					'Este aluno já possui um tablet registrado/planejado em outro lote.',
// 				);
// 			}
...
// 			if (assetRes.rows.length === 0)
// 				throw new Error('Sem tablets disponíveis no estoque.');
// 			const asset = assetRes.rows[0];
...
// 				return res
// 					.status(400)
// 					.json({ message: 'Formato não suportado.' });
// 			}
// 			fs.unlinkSync(filePath);
...
// 					const RAW_LIVOX =
// 						row['LIVOX'] || row['Livox'] || row['SOFTWARE'];
// 					const RAW_RESERVA =
// 						row['RESERVA'] ||
// 						row['Reserva'] ||
// 						row['RESERVA_TECNICA'];
...
// 					const tombamentoLimpo = String(TOMBAMENTO).replace(
// 						/\D/g,
// 						'',
// 					);
...
// 						errors.push(
// 							`Linha ${line}: Tombamento '${TOMBAMENTO}' não encontrado.`,
// 						);
// 						continue;
// 					}
...
// 						errors.push(
// 							`Linha ${line}: Ativo '${TOMBAMENTO}' não é um Tablet.`,
// 						);
// 						continue;
// 					}
...
// // =====================================================================
// app.post(
// 	'/api/delivery-batches/:id/distribute-automatically',
// 	authenticateToken,
// 	authorizePermission('MENU_ESCOLAR'),
// 	async (req, res) => {
// 		const { id: batch_id } = req.params;
...
// 			// 1. Dados do Lote
// 			const batchRes = await client.query(
// 				'SELECT school_unit_id FROM delivery_batches WHERE id = $1 FOR UPDATE',
// 				[batch_id],
// 			);
// 			if (batchRes.rows.length === 0)
// 				throw new Error('Lote não encontrado.');
...
// 					warnings.push(
// 						`Alerta: Faltam ${pcdStudents.length - pcdAssets.length} tablets com LIVOX no estoque liberado.`,
// 					);
// 				}
// 			}
...
// 					warnings.push(
// 						`Alerta: Faltam ${stdStudents.length - stdAssets.length} tablets regulares no estoque liberado.`,
// 					);
// 				}
// 			}
...
// 				'delivery_batches',
// 				batch_id,
// 				{ pcd: successPcd, std: successStandard, warnings },
// 				ipAddress,
// 			);
...
// 			res.status(500).json({
// 				message: 'Erro ao processar distribuição.',
// 				error: error.message,
// 			});
// 		} finally {
// 			client.release();
...
// // =====================================================================
// app.get(
// 	'/api/reports/delivery-batch/:id/collective',
// 	authenticateToken,
// 	async (req, res) => {
// 		const { id: batch_id } = req.params;
// 		const ipAddress = req.ip;
...
// 					{
// 						text: item.serial_number || 'N/A',
// 						alignment: 'center',
// 						fontSize: 9,
// 					},
// 					{
// 						text: item.patrimonio_number,
// 						alignment: 'center',
// 						fontSize: 9,
// 						bold: true,
// 					},
...
// 							stack: [
// 								{
// 									text: 'PREFEITURA DO RECIFE',
// 									bold: true,
// 									fontSize: 11,
// 								},
// 								{
// 									text: 'SECRETARIA DE EDUCAÇÃO',
// 									bold: true,
// 									fontSize: 10,
// 								},
// 								{
// 									text: 'SECRETARIA EXECUTIVA DE PROJETOS, TECNOLOGIA E INOVAÇÃO',
// 									fontSize: 9,
// 								},
// 								{
...
// 								},
// 								{
// 									text: 'DIVISÃO DE INFRAESTRUTURA EM TECNOLOGIA',
// 									fontSize: 9,
// 								},
// 							],
// 							alignment: 'center',
...
// 						},
// 						{
// 							text: 'Av. Oliveira Lima, 824 – Soledade',
// 							alignment: 'center',
// 							fontSize: 9,
// 						},
// 						{
// 							text: 'CEP: 50050-390 | FONE: 3355-5471',
// 							alignment: 'center',
// 							fontSize: 9,
// 						},
// 					],
...
// 					// ========== PÁGINA 1: RECIBO ==========
// 					{
// 						text: 'RECIBO DE ENTREGA DE BENS',
// 						style: 'title',
// 						alignment: 'center',
// 						margin: [0, 0, 0, 20],
// 					},
...
// 					// Totalizador
// 					{
// 						text: `Total: ${items.length} equipamentos`,
// 						alignment: 'center',
// 						bold: true,
// 						margin: [0, 5, 0, 10],
// 					},
...
// 					// Data
// 					{
// 						text: `Recife, ${new Date().toLocaleDateString('pt-BR')}`,
// 						alignment: 'right',
// 						margin: [0, 0, 0, 20],
// 					},
...
// 									},
// 									{
// 										text: 'Gerente de Infraestrutura de Tecnologia',
// 										fontSize: 8,
// 										alignment: 'center',
// 									},
// 									{
// 										text: 'Matrícula 123.738-1',
// 										fontSize: 8,
// 										alignment: 'center',
// 									},
// 									{
// 										text: 'Responsável pela Liberação',
// 										fontSize: 8,
// 										alignment: 'center',
// 										italics: true,
// 										margin: [0, 2, 0, 0],
...
// 									},
// 									{
// 										text: '(Nome, Cargo e Matrícula Legíveis)',
// 										fontSize: 7,
// 										italics: true,
// 										alignment: 'center',
// 									},
...
// 					{
// 						text: 'Recebido em ____/____/______',
// 						alignment: 'center',
// 						margin: [0, 0, 0, 20],
// 					},
...
// // =====================================================================
// app.get(
// 	'/api/reports/delivery-item/:id/term',
// 	authenticateToken,
// 	async (req, res) => {
...
// 				[
// 					{ text: 'QTD', style: 'th' },
// 					{ text: 'EQUIPAMENTO / DESCRIÇÃO', style: 'th' },
// 					{ text: 'IDENTIFICADOR', style: 'th' },
// 				],
// 			];
...
// 					},
// 					{
// 						text: 'LINHA CHIP DE DADOS COM PACOTE DE 20GB/MENSAL - OPERADORA CLARO',
// 						fontSize: 9,
// 						margin: [0, 2],
// 					},
// 					{
// 						text: `Nº DA LINHA: ${data.sim_card_number}`,
// 						fontSize: 8,
// 						bold: true,
// 						margin: [0, 2],
// 					},
...
// 			if (
// 				data.imei &&
// 				String(data.imei).trim() !== '' &&
// 				String(data.imei).toUpperCase() !== 'N/A'
// 			) {
...
// 				{
// 					text: `TABLET ${data.brand || ''} ${data.model || ''}, CARREGADOR E CAPA`.trim(),
// 					fontSize: 9,
// 					margin: [0, 2],
// 				},
...
// 							stack: [
// 								{
// 									text: 'PREFEITURA DA CIDADE DO RECIFE',
// 									bold: true,
// 									fontSize: 11,
// 								},
// 								{
...
// 				content: [
// 					{
// 						text: 'TERMO DE PERMISSÃO DE USO',
// 						style: 'title',
// 						alignment: 'center',
// 						margin: [0, 10, 0, 10],
// 					},
...
// 					// Tabela Aluno
// 					{
// 						text: 'DADOS DO ESTUDANTE (PERMISSIONÁRIO)',
// 						style: 'sectionHeader',
// 						margin: [0, 10, 0, 2],
// 					},
// 					{
...
// 									},
// 									{
// 										text: data.student_registration,
// 										fontSize: 8,
// 										alignment: 'center',
// 									},
// 									{
// 										text: data.education_year || '-',
// 										fontSize: 8,
// 										alignment: 'center',
// 									},
...
// 						[
// 							{
// 								text: 'HISTÓRICO DE SUBSTITUIÇÃO',
// 								style: 'sectionHeader',
// 								margin: [0, 10, 0, 2],
// 								color: '#b91c1c',
// 							},
...
// 										[
// 											{
// 												text: 'EQUIPAMENTO ANTERIOR (RECOLHIDO)',
// 												style: 'th',
// 												fillColor: '#fff1f2',
// 											},
// 											{
// 												text: 'MOTIVO DA TROCA',
// 												style: 'th',
// 												fillColor: '#fff1f2',
// 											},
// 										],
...
// 													oldAssetDetails?.imei ?
// 														` | IMEI: ${oldAssetDetails.imei}`
// 													:	'',
// 													(
...
// 					{
// 						text: 'DESCRIÇÃO DOS EQUIPAMENTOS CEDIDOS (ATUAL)',
// 						style: 'sectionHeader',
// 						margin: [0, 10, 0, 2],
// 					},
// 					{
...
// 								bold: true,
// 							},
// 							'O objeto do presente contrato é permissão de uso, a título gratuito, dos equipamentos discriminados na tabela acima, tudo de propriedade do PERMITENTE para uso exclusivo do (a) PERMISSIONÁRIO (A).',
// 						],
// 						style: 'clause',
// 					},
...
// 							'O PERMISSIONÁRIO (A) declara que recebeu, na data da assinatura deste ato, os equipamentos, objeto deste contrato, e seus acessórios em perfeito estado de conservação e funcionamento.',
// 						],
// 						style: 'clause',
// 					},
...
// 							'Os equipamentos objeto desta permissão de uso destinam-se, exclusivamente, ao uso individual do (a) PERMISSIONÁRIO (A) dentro e fora do ambiente escolar, como material de apoio pedagógico do (a) estudante-PERMISSIONÁRIO, sendo vedada a sua utilização em destinação diversa da estabelecida neste instrumento.',
// 						],
// 						style: 'clause',
// 					},
...
// 						text: [
// 							{
// 								text: 'CLÁUSULA SEGUNDA – DO PRAZO – ',
// 								bold: true,
// 							},
// 							'O prazo da presente permissão é de 6 (seis) anos, contados a partir da data de sua assinatura.',
// 						],
// 						style: 'clause',
// 					},
...
// 							'Na hipótese de reprovação do (a) PERMISSIONÁRIO (A) será admitida prorrogação do prazo contratual, uma única vez, pelo novo interregno faltante para conclusão do Ensino Fundamental, condicionado à realização da nova matrícula para a mesma série em que se deu a reprovação, dentro dos prazos regulares divulgados pela Secretaria de Educação.',
// 						],
// 						style: 'clause',
// 					},
...
// 						text: [
// 							{
// 								text: 'CLÁUSULA QUARTA – DA RESPONSABILIDADE PERANTE TERCEIROS – ',
// 								bold: true,
// 							},
// 							'O PERMITENTE não será responsável por quaisquer e eventuais danos ou indenizações a terceiros causados por ato do (a) PERMISSIONÁRIO (A) em decorrência do uso, direto ou indireto, do equipamento objeto deste ajuste, cabendo ainda ao PERMISSIONÁRIO responder por perdas e danos causados pelo uso da coisa emprestada em desacordo com a finalidade prevista na CLÁUSULA PRIMEIRA.',
// 						],
// 						style: 'clause',
// 					},
...
// 						text: [
// 							{
// 								text: 'CLÁUSULA QUINTA – DA DEVOLUÇÃO DO BEM – ',
// 								bold: true,
// 							},
// 							'Terminado o prazo de vigência contratual, bem como nas hipóteses de rescisão unilateral do contrato e de impossibilidade de prorrogação no prazo contratual, o (a) PERMISSIONÁRIO (A) se obriga a restituir o equipamento que lhe foi cedido em bom estado de uso e conservação, entregando-o à pessoa encarregada da gestão da unidade escolar.',
// 						],
// 						style: 'clause',
// 					},
...
// 						text: [
// 							{
// 								text: 'CLÁUSULA SEXTA – DA RESCISÃO DO CONTRATO - ',
// 								bold: true,
// 							},
// 							'Constitui causa para rescisão unilateral do contrato: a) a não realização, na vigência do contrato, de matrícula escolar, dentro dos prazos regulares divulgados pela SECRETARIA DE EDUCAÇÃO, em unidade de ensino da rede pública municipal de educação; b) a reprovação por falta, na vigência do contrato; c) a ausência injustificada do aluno em sala de aula, por período superior a 30 (trinta) dias, comprovadas a partir das anotações constantes do Diário de Classe.',
// 						],
// 						style: 'clause',
// 					},
...
// 						text: [
// 							{
// 								text: 'CLÁUSULA SÉTIMA– DAS SANÇÕES – ',
// 								bold: true,
// 							},
// 							'A falta de devolução do bem objeto deste ajuste, bem como sua inutilização sujeitará o (a) PERMISSIONÁRIO (A) às sanções e medidas cabíveis previstas na legislação de regência.',
// 						],
// 						style: 'clause',
// 					},
...
// 								bold: true,
// 							},
// 							'É competente o foro da Comarca do Recife, Capital do Estado de Pernambuco, para dirimir qualquer divergência ou dúvida fundada no presente instrumento que não possa ser resolvido pela via administrativa, renunciando as partes a qualquer outro por mais privilegiado que seja.',
// 						],
// 						style: 'clause',
// 					},

// 					{
// 						text: 'É por estarem justas e contratadas, as partes na presença das testemunhas abaixo, assinam o presente instrumento, em 02 (duas) vias de igual teor e forma.',
// 						margin: [0, 5, 0, 10],
// 						fontSize: 8,
// 					},
...
// 					// ASSINATURAS P1
// 					{
// 						text: `Recife, _____ de ___________________ de ${new Date().getFullYear()}.`,
// 						alignment: 'center',
// 						margin: [0, 100, 0, 80],
// 						fontSize: 9,
// 					},
...
// 									},
// 									{
// 										text: 'REPRESENTANTE DA SECRETARIA',
// 										bold: true,
// 										fontSize: 8,
// 										alignment: 'center',
// 									},
...
// 									},
// 									{
// 										text: '(Carimbar com dados do gestor)',
// 										fontSize: 6,
// 										italics: true,
// 										alignment: 'center',
// 									},
...
// 									},
// 									{
// 										text: 'REPRESENTANTE DO ESTUDANTE',
// 										bold: true,
// 										fontSize: 8,
// 										alignment: 'center',
// 									},
...
// 					},
// 					{
// 						text: 'TERMOS E CONDIÇÕES DE USO DO EQUIPAMENTO E CONECTIVIDADE',
// 						style: 'subheader',
// 						alignment: 'center',
// 						margin: [0, 15, 0, 20],
// 					},
...
// 					{
// 						text: 'OBRIGAÇÕES DO ESTUDANTE E/OU RESPONSÁVEL:',
// 						style: 'sectionHeader',
// 						fontSize: 9,
// 					},
// 					{
// 						text: 'O equipamento (TABLET) e a conectividade a ele vinculada (quando aplicável) são para uso exclusivo e individual do(a) estudante como instrumento/recurso de apoio às suas atividades pedagógicas, sendo deveres diários do(a) estudante seguir as orientações abaixo:',
// 						style: 'body',
// 						margin: [0, 5],
// 					},
// 					{
...
// 					{
// 						text: 'São obrigações do(a) estudante e/ou responsável zelar pelo integral cumprimento de todas as orientações descritas acima, sob pena de imediato bloqueio e recolhimento do equipamento, sendo vedado também o uso do mesmo nas seguintes situações:',
// 						style: 'body',
// 						margin: [0, 5],
// 					},
// 					{
...
// 					},
// 					{
// 						text: 'Ratificamos que o equipamento (tablet) é de uso exclusivo do(a) estudante e poderá ser monitorado a distância. Qualquer descumprimento dos termos e condições de uso acarretará no recolhimento do equipamento ou sua completa desativação remotamente. Todos os acessos e consultas efetuados através do equipamento ou da conectividade disponibilizada poderão ser registrados pela SEDUC e estarão sujeitos ao seu monitoramento.',
// 						style: 'body',
// 						margin: [0, 5],
// 					},
// 					{
// 						text: 'O usuário autoriza expressamente a SEDUC a coletar, usar e armazenar seus dados para fins de monitoramento das atividades pedagógicas desenvolvidas pelo estudante e do uso adequado do equipamento. Os dados pessoais do estudante serão excluídos definitivamente mediante requerimento do próprio usuário ou ao término da relação entre as partes, obedecido o prazo de guarda estabelecido em lei e observadas as exceções previstas no art. 16 da Lei Federal nº 13.709/2018.',
// 						style: 'body',
// 						margin: [0, 5],
// 					},
// 					{
// 						text: 'Salientamos que a transferência, venda ou cessão para terceiros do equipamento ou da conectividade de uso exclusivo do estudante é ilegal e os responsáveis estarão sujeitos às sanções civis e penais cabíveis.',
// 						style: 'body',
// 						margin: [0, 5],
// 					},
// 					{
// 						text: 'A Secretaria de Educação do Recife não será responsável por quaisquer eventuais danos ou indenizações a terceiros causados em decorrência do uso, direto ou indireto, do equipamento ou conectividade objeto deste termo, cabendo ao responsável pelo(a) estudante responder por danos causados pelo uso em desacordo com a finalidade educativa.',
// 						style: 'body',
// 						margin: [0, 5],
// 					},
// 					{
// 						text: 'O recolhimento do equipamento e/ou a desativação do seu acesso, a qualquer tempo, não gera direito a qualquer indenização ao estudante ou seu responsável por parte da Secretaria de Educação.',
// 						style: 'body',
// 						margin: [0, 5],
// 					},
...
// 							},
// 							{
// 								text: 'Nome: ____________________________________',
// 								width: 'auto',
// 								fontSize: 9,
// 								margin: [0, 0, 0, 25],
// 							},
// 							{
// 								text: 'CPF: __________________________',
// 								width: 'auto',
// 								fontSize: 9,
// 							},
// 						],
...
// 			pdfDoc.on('data', (chunk) => chunks.push(chunk));
// 			pdfDoc.on('end', () => {
// 				const safeName = data.student_name
// 					.replace(/[^a-z0-9]/gi, '_')
// 					.toLowerCase();
// 				res.header('Content-Type', 'application/pdf');
...
// 				'SELECT asset_id FROM delivery_batch_items WHERE id = $1',
// 				[id],
// 			);
...
// 				"SELECT id FROM units WHERE name ILIKE '%Almoxarifado%' LIMIT 1",
// 			);
// 			const warehouseId = whRes.rows[0]?.id || null;

// 			// 2. Remove a associação
// 			await client.query(
// 				'DELETE FROM delivery_batch_items WHERE id = $1',
// 				[id],
// 			);

// 			// 3. Libera o tablet (volta para 'available' e para o Almoxarifado)
// 			await client.query(
// 				"UPDATE assets SET status = 'available', current_unit_id = $1 WHERE id = $2",
// 				[warehouseId, asset_id],
// 			);

// 			await client.query('COMMIT');
// 			res.status(200).json({
// 				message: 'Associação removida. Tablet liberado.',
// 			});
// 		} catch (error) {
// 			await client.query('ROLLBACK');
...
// // =====================================================================
// app.post(
// 	'/api/reports/blank-collection-order',
// 	authenticateToken,
// 	async (req, res) => {
// 		try {
...
// 			const totalLines =
// 				estimated_quantity ? parseInt(estimated_quantity) : 20;
...
// 				content: [
// 					{
// 						text: 'ORDEM DE COLETA E TRANSFERÊNCIA DE CUSTÓDIA',
// 						style: 'header',
// 						alignment: 'center',
// 						margin: [0, 0, 0, 5],
// 					},
...
// 					{
// 						text: 'RELAÇÃO DE EQUIPAMENTOS RECOLHIDOS:',
// 						fontSize: 10,
// 						bold: true,
// 						margin: [0, 0, 0, 5],
// 					},
...
// 							},
// 							{
// 								text: 'TERMO DE TRANSFERÊNCIA DE RESPONSABILIDADE',
// 								style: 'sectionHeader',
// 								margin: [0, 10, 0, 5],
// 							},
...
// 									' e a ',
// 									{
// 										text: 'TRANSFERÊNCIA DA CUSTÓDIA',
// 										bold: true,
// 									},
...
// 											},
// 											{
// 												text: 'Gestor(a) da Unidade Escolar',
// 												bold: true,
// 												fontSize: 9,
// 												alignment: 'center',
// 											},
// 											{
// 												text: '(Entreguei os itens)',
// 												fontSize: 8,
// 												italics: true,
// 												alignment: 'center',
// 											},
...
// 											},
// 											{
// 												text: '(Recebi e conferi a contagem)',
// 												fontSize: 8,
// 												italics: true,
// 												alignment: 'center',
// 											},
...
// // =====================================================================
// app.get(
// 	'/api/reports/delivery-batch/:id/all-terms',
// 	authenticateToken,
// 	async (req, res) => {
// 		const { id: batch_id } = req.params;
// 		const ipAddress = req.ip;
...
// 				return res
// 					.status(404)
// 					.json({ message: 'Lote vazio ou não encontrado.' });
...
// 					{
// 						text: 'DESCRIÇÃO DOS EQUIPAMENTOS CEDIDOS',
// 						style: 'sectionHeader',
// 						margin: [0, 2, 0, 2],
// 					},
// 					{
...
// 									String(data.serial_number).toUpperCase() !==
// 										'N/A'
// 								) {
...
// 			return res.status(400).json({
// 				message:
// 					'Unidade, Nome do Lote e Data de Previsão são obrigatórios.',
// 			});
// 		}
...
// 				throw new Error(
// 					`Esta unidade já possui o lote "${existingBatch.name}" em planejamento. Utilize a função de "Editar Lote" ou "Lote Complementar".`,
// 				);
// 			}
...
// 				'delivery_batches',
// 				newBatch.id,
// 				{ name: batch_name, school_unit_id, scheduled_date },
// 				ipAddress,
// 			);
...
// 			const status =
// 				error.message.includes('já possui o lote') ? 409 : 500;
...
// 			await logAudit(
// 				req.user.id,
// 				'update_delivery_batch',
// 				'delivery_batches',
// 				id,
// 				{ batch_name, scheduled_date },
// 				ipAddress,
// 			);
...
// 			return res
// 				.status(400)
// 				.json({ message: 'Matrícula e Nova Escola são obrigatórias.' });
// 		}
...
// 				messageExtra =
// 					' O aluno foi removido do lote de planejamento anterior e o tablet foi liberado.';
// 			}
...
// 			res.json({
// 				message: `Aluno transferido com sucesso.${messageExtra}`,
// 			});
// 		} catch (error) {
// 			await client.query('ROLLBACK');
// 			console.error('Erro na transferência:', error);
// 			res.status(500).json({
// 				message: error.message || 'Erro ao transferir aluno.',
// 			});
// 		} finally {
// 			client.release();
// 		}
...
// app.get(
// 	'/api/tablets/eligible-students/:school_unit_id',
// 	authenticateToken,
// 	authorizePermission('MENU_ESCOLAR'),
// 	async (req, res) => {
...
// 			);
// 			res.status(201).json({
// 				message: 'Ativo associado ao aluno com sucesso!',
// 			});
// 		} catch (error) {
// 			await client.query('ROLLBACK');
...
// // =====================================================================
// app.put(
// 	'/api/delivery-batches/:id/confirm',
// 	authenticateToken,
// 	authorizePermission('MENU_ESCOLAR'),
...
// 			return res
// 				.status(400)
// 				.json({ message: 'É obrigatório anexar o Recibo Coletivo.' });
...
// 			if (exceptions) {
// 				try {
// 					exceptionsList = JSON.parse(exceptions);
// 				} catch (e) {}
// 			}
// 			const exceptionsMap = new Map(
// 				exceptionsList.map((e) => [parseInt(e.itemId), e.reason]),
// 			);

// 			const batchResult = await client.query(
// 				'SELECT * FROM delivery_batches WHERE id = $1',
// 				[batch_id],
// 			);
...
// 				[
// 					responsible_user_id,
// 					batch.school_unit_id,
// 					`Entrega Lote #${batch_id}`,
// 					req.file.path,
// 				],
// 			);
...
// 					await client.query(
// 						`UPDATE delivery_batch_items SET delivery_status = 'devolvido', notes = $1 WHERE id = $2`,
// 						[`Não entregue: ${exceptionReason}`, item.id],
// 					);

// 					// CORREÇÃO V5: Volta para Almoxarifado
// 					await client.query(
// 						`UPDATE assets SET status = 'available', current_unit_id = $1 WHERE id = $2`,
// 						[warehouseId, item.asset_id],
// 					);

// 					if (return_movement_id) {
// 						await client.query(
// 							`INSERT INTO movement_assets (movement_id, asset_id) VALUES ($1, $2)`,
// 							[return_movement_id, item.asset_id],
// 						);
// 					}
// 				} else {
// 					// CASO 2: ENTREGUE (Sucesso)
// 					await client.query(
// 						`UPDATE delivery_batch_items SET delivery_status = 'realizada', delivery_date = CURRENT_DATE WHERE id = $1`,
// 						[item.id],
// 					);
// 					await client.query(
// 						`UPDATE tablet_eligible_students SET delivery_movement_id = $1 WHERE id = $2`,
// 						[exit_movement_id, item.eligible_student_id],
// 					);
// 					await client.query(
// 						`INSERT INTO movement_assets (movement_id, asset_id) VALUES ($1, $2)`,
// 						[exit_movement_id, item.asset_id],
// 					);
// 				}
// 			}
...
// 				'delivery_batches',
// 				batch_id,
// 				{ partial: exceptionsList.length > 0 },
// 				ipAddress,
// 			);
// 			res.status(200).json({
...
// // =====================================================================
// app.post(
// 	'/api/delivery-batch-items/:id/return',
// 	authenticateToken,
...
// 			return res
// 				.status(400)
// 				.json({ message: 'O motivo da devolução é obrigatório.' });
...
// 			res.json({
// 				message:
// 					'Devolução registrada com sucesso. Tablet disponível novamente.',
// 			});
// 		} catch (error) {
// 			await client.query('ROLLBACK');
...
// app.get(
// 	'/api/tablets/student-status/:matricula',
// 	authenticateToken,
// 	async (req, res) => {
...
// 			if (
// 				newAssetRes.rows[0].status !== 'available' &&
// 				newAssetRes.rows[0].status !== 'maintenance'
// 			) {
// 				throw new Error(
// 					`O novo tablet não está disponível (Status: ${newAssetRes.rows[0].status}).`,
// 				);
// 			}
...
// 				[
// 					`Substituído em ${new Date().toLocaleDateString()}. Motivo: ${reason}`,
// 					old_item_id,
// 				],
// 			);
...
// 			return res
// 				.status(400)
// 				.json({ message: 'O novo número do chip é obrigatório.' });
// 		}
...
// 			const assetRes = await client.query(
// 				'SELECT sim_card_number, imei, notes, patrimonio_number FROM assets WHERE id = $1',
// 				[id],
// 			);
...
// 			res.json({
// 				message: 'Chip e dados técnicos atualizados com sucesso.',
// 			});
// 		} catch (error) {
// 			await client.query('ROLLBACK');
// 			console.error('Erro na troca de chip:', error);
// 			res.status(500).json({
// 				message: 'Erro ao processar troca: ' + error.message,
// 			});
// 		} finally {
// 			client.release();
// 		}
...
// // =====================================================================
// // LISTAR ESCOLAS COM ALUNOS (ORDENADAS POR DEMANDA)
// // =====================================================================
// app.get(
// 	'/api/tablets/schools-with-students',
// 	authenticateToken,
// 	async (req, res) => {
// 		try {
// 			const query = `
...
// 			res.json(result.rows);
// 		} catch (error) {
// 			console.error('Erro ao buscar escolas com alunos:', error);
// 			res.status(500).json({ message: 'Erro interno.' });
// 		}
// 	},
// );
...
// 			const batchRes = await client.query(
// 				'SELECT id, name, status FROM delivery_batches WHERE id = $1',
// 				[batch_id],
// 			);
// 			if (batchRes.rows.length === 0)
// 				throw new Error('Lote não encontrado.');
...
// 			// 2. Liberar os Tablets (Voltar para 'available')
// 			// Atualiza todos os assets que estão ligados a itens deste lote
// 			await client.query(
// 				`
//       UPDATE assets 
...
// 			// 3. Apagar os Itens do Lote (Associações)
// 			await client.query(
// 				'DELETE FROM delivery_batch_items WHERE batch_id = $1',
// 				[batch_id],
// 			);

// 			// 4. Apagar o Lote
// 			await client.query('DELETE FROM delivery_batches WHERE id = $1', [
// 				batch_id,
// 			]);
...
// 			await logAudit(
// 				req.user.id,
// 				'delete_delivery_batch',
// 				'delivery_batches',
// 				batch_id,
// 				{ name: batch.name, status: batch.status },
// 				ipAddress,
// 			);

// 			res.status(200).json({
// 				message: 'Lote excluído e tablets liberados com sucesso.',
// 			});
// 		} catch (error) {
// 			await client.query('ROLLBACK');
// 			console.error('Erro ao excluir lote:', error);
// 			// Tratamento para erro de chave estrangeira (caso mude a estrutura no futuro)
// 			if (error.code === '23503') {
// 				return res.status(400).json({
// 					message:
// 						'Não é possível excluir este lote pois existem registros dependentes.',
// 				});
// 			}
...
// // =====================================================================
// app.get(
// 	'/api/delivery-batches/pending-terms',
// 	authenticateToken,
// 	authorizePermission('MENU_ESCOLAR'),
// 	async (req, res) => {
// 		try {
...
// // =====================================================================
// app.put(
// 	'/api/delivery-batches/:id/register-contact',
// 	authenticateToken,
// 	authorizePermission('MENU_ESCOLAR'),
// 	async (req, res) => {
// 		const { id } = req.params;
...
// 			await client.query('COMMIT');
// 			res.status(200).json({
// 				message: 'Cobrança registrada no histórico!',
// 			});
// 		} catch (error) {
// 			await client.query('ROLLBACK');
...
// // =====================================================================
// app.get(
// 	'/api/delivery-batches/:id/items-for-terms',
// 	authenticateToken,
// 	authorizePermission('MENU_ESCOLAR'),
// 	async (req, res) => {
// 		const { id } = req.params;
...
// // =====================================================================
// app.put(
// 	'/api/delivery-batches/:id/register-terms-checklist',
// 	authenticateToken,
// 	authorizePermission('MENU_ESCOLAR'),
// 	async (req, res) => {
// 		const { id } = req.params;
...
// 			const newStatus =
// 				termsReceivedCount === totalValidItems && totalValidItems > 0 ?
// 					'completed'
// 				:	'partial';
...
// 			res.status(500).json({
// 				message: 'Erro ao processar a baixa documental.',
// 			});
// 		} finally {
// 			client.release();
// 		}
...
// // =====================================================================
// app.put(
// 	'/api/delivery-batches/:id/register-terms',
// 	authenticateToken,
// 	authorizePermission('MENU_ESCOLAR'),
// 	async (req, res) => {
// 		const { id: batch_id } = req.params;
...
// 			return res.status(400).json({
// 				message: 'Data de recebimento e status são obrigatórios.',
// 			});
// 		}
...
// 			res.status(200).json({
// 				message: 'Devolutiva de termos registrada com sucesso!',
// 			});
// 		} catch (error) {
// 			await client.query('ROLLBACK');
// 			console.error('Erro ao registrar devolutiva de termos:', error);
// 			res.status(500).json({
// 				message: error.message || 'Erro ao registrar devolutiva.',
// 			});
// 		} finally {
// 			client.release();
// 		}
...
// // =====================================================================
// app.get(
// 	'/api/analytics/schools-performance',
// 	authenticateToken,
// 	async (req, res) => {
// 		try {
// 			const { whereClause, values } = buildDashboardFilters(req.query);
...
// 						(
// 							(parseInt(row.delivered_count) /
// 								parseInt(row.total_students)) *
// 							100
// 						).toFixed(1)
// 					:	0,
// 			}));
...
// 				const lastItemType = await client.query(
// 					'SELECT code FROM item_types ORDER BY id DESC LIMIT 1',
// 				);
// 				let nextCodeNum = 1;
...
// 					const sku_code =
// 						row['Código SKU (3 Letras)'] || row['sku_code'];
// 					const description =
// 						row['Descrição (Opcional)'] || row['description'];

// 					// ✨ CORRIGIDO: Validação agora inclui o sku_code
// 					if (!name || !sku_code) {
// 						errors.push(
// 							`Linha ignorada: 'Nome' e 'Código SKU' são obrigatórios. Dados: ${JSON.stringify(row)}`,
// 						);
// 						continue;
// 					}
...
// 					if (String(sku_code).length !== 3) {
// 						errors.push(
// 							`Linha ignorada para '${name}': O Código SKU deve ter 3 caracteres. Valor recebido: '${sku_code}'`,
// 						);
// 						continue;
// 					}
...
// 			);
// 			res.status(500).json({
// 				message: 'Erro interno do servidor ao importar tipos de itens.',
// 				error: error.message,
// 			});
// 		}
// 	},
...
// 				message: `Erro ao processar o arquivo: ${readError.message}`,
// 			});
// 		} finally {
// 			if (fs.existsSync(filePath)) fs.unlinkSync(filePath);
// 		}
...
// 			);
// 			const unitNameToIdMap = new Map(
// 				allUnitsResult.rows.map((u) => [u.name, u.id]),
// 			);
...
// 					if (!name || !type) {
// 						errors.push(
// 							`Linha ${index + 2}: 'name' e 'type' são obrigatórios.`,
// 						);
// 						continue;
// 					}
...
// 					if (!parentId) {
// 						errors.push(
// 							`Linha ${index + 2}: Unidade superior '${parent_name}' para '${name}' não foi encontrada.`,
// 						);
// 						continue;
// 					}

// 					const result = await upsertUnit(client, {
// 						...row,
// 						parent_id: parentId,
// 					});
// 					if (result.isNew) importedCount++;
...
// 			);
// 			res.status(500).json({
// 				message: `Erro durante a transação: ${error.message}`,
// 				errors,
// 			});
// 		} finally {
// 			client.release();
...
// 	// Validações básicas
// 	if (
// 		type.toUpperCase() === 'ESCOLAR' &&
// 		(!code || String(code).trim() === '')
// 	) {
// 		throw new Error(
// 			`Unidade '${name}' é do tipo ESCOLAR mas está sem Código (INEP).`,
// 		);
// 	}
...
// 		if (assets.length === 0) {
// 			return res.status(404).json({
// 				message: 'Nenhum ativo encontrado para gerar relatório.',
// 			});
// 		}
...
// 					asset.acquisition_date.toISOString().split('T')[0]
// 				:	'',
// 				asset.warranty_end_date ?
// 					asset.warranty_end_date.toISOString().split('T')[0]
// 				:	'',
...
// 			'asset_report_csv',
// 			null,
// 			{ format: 'CSV', count: assets.length },
// 			ipAddress,
// 		);
// 	} catch (error) {
...
// 		res.status(500).json({
// 			message:
// 				'Erro interno do servidor ao gerar relatório CSV de ativos.',
// 		});
// 	}
// });
...
// 			res,
// 			'Ativos',
// 			'Relatorio_Ativos_Completo.xlsx',
// 			columns,
// 			rows,
// 		);
// 	} catch (error) {
...
// 				},
// 				{
// 					text: 'Sistema de Gestão de Ativos - SGA',
// 					style: 'subheader',
// 					alignment: 'center',
// 				},
// 				{ text: '\n\n' },
...
// 			'asset_report_pdf',
// 			null,
// 			{ format: 'PDF', count: assets.length },
// 			ipAddress,
// 		);
// 	} catch (error) {
...
// 		if (!res.headersSent) {
// 			res.status(500).json({
// 				message: 'Erro interno do servidor ao gerar o PDF.',
// 			});
// 		}
// 	}
// });
...
// // =====================================================================
// app.post(
// 	'/api/reports/preview-return-term',
// 	authenticateToken,
// 	async (req, res) => {
// 		try {
// 			const {
...
// 				if (fs.existsSync(p)) {
// 					try {
// 						logoBase64 = fs.readFileSync(p, 'base64');
// 						break;
// 					} catch (e) {}
// 				}
// 			}
...
// 						stack: [
// 							{
// 								text: `NOME: ${recipient_name || ''}`,
// 								style: 'infoBox',
// 								bold: true,
// 							},
// 							{
// 								text: `UNIDADE: ${unit_name || ''}`,
// 								style: 'infoBox',
// 							},
// 						],
// 					},
...
// 						{
// 							text: `${a.item_type_name || 'Equipamento'} ${a.brand || ''} ${a.model || ''}`.toUpperCase(),
// 							style: 'tableCellLeft',
// 						},
// 						{ text: a.serial_number || '-', style: 'tableCell' },
// 						{
// 							text: a.patrimonio_number || '-',
// 							style: 'tableCell',
// 							bold: true,
// 						},
// 					]);
...
// 					text: [
// 						'Atestamos o ',
// 						{ text: 'RECOLHIMENTO DEFINITIVO', bold: true },
// 						' dos equipamentos abaixo.\n',
// 						{
// 							text: `Motivo: ${reason || 'Devolução ao Estoque'}`,
// 							italics: true,
// 						},
// 					],
// 					style: 'infoBox',
...
// 				// VISTORIA TÉCNICA
// 				{
// 					text: 'CONFERÊNCIA TÉCNICA DE DEVOLUÇÃO (VISTORIA)',
// 					style: 'sectionTitle',
// 					margin: [0, 10, 0, 5],
// 					color: '#b91c1c',
// 				},
...
// 						body: [
// 							[
// 								{ text: '[   ] Mouse', fontSize: 8 },
// 								{ text: '[   ] Teclado', fontSize: 8 },
// 								{ text: '[   ] Fonte', fontSize: 8 },
// 								{ text: '[   ] Cabos', fontSize: 8 },
// 							],
// 						],
// 					},
// 					layout: 'noBorders',
...
// 				},
// 				{
// 					text: 'Observações sobre o Estado de Conservação / Avarias:',
// 					fontSize: 8,
// 					bold: true,
// 				},
// 				{
...
// 				{
// 					text: 'TERMO DE DEVOLUÇÃO E DESONERAÇÃO',
// 					style: 'docTitle',
// 					margin: [0, 10, 0, 20],
// 				},

// 				{
// 					text: 'Declaro que DEVOLVI à Gerência de Infraestrutura de Tecnologia GIT, todos os equipamentos e acessórios constantes no recibo (verso), os quais foram conferidos pela equipe técnica.',
// 					style: 'legalText',
// 					margin: [0, 0, 0, 15],
// 				},

// 				{
// 					text: '1. Declaro estar ciente de que a devolução dos equipamentos encerra minha responsabilidade de guarda sobre os mesmos a partir desta data.',
// 					style: 'legalText',
// 				},

// 				{
// 					text: '2. Atesto que os equipamentos foram devolvidos nas condições informadas no ato do recebimento pela equipe técnica.',
// 					style: 'legalText',
// 					margin: [0, 0, 0, 30],
// 				},
...
// // =====================================================================
// app.post(
// 	'/api/reports/preview-substitution',
// 	authenticateToken,
// 	async (req, res) => {
// 		try {
// 			const {
...
// 					{ text: 'EQUIPAMENTO DEVOLVIDO', style: 'tableHeader' },
...
// 			const contentReturn = [
// 				{
// 					text: 'RECIBO DE DEVOLUÇÃO (SUBSTITUIÇÃO)',
// 					style: 'docTitle',
// 				},
// 				{ text: 'DADOS DO RESPONSÁVEL', style: 'sectionTitle' },
// 				getUserInfoBox(),
...
// 					text: [
// 						'Declaramos o ',
// 						{ text: 'RECEBIMENTO/RECOLHIMENTO', bold: true },
// 						' do(s) equipamento(s) abaixo.\n',
// 						'Motivo da Substituição: ',
// 						{ text: reason || 'Não informado', italics: true },
// 					],
// 					style: 'body',
// 					margin: [0, 0, 0, 10],
// 				},
...
// 						headerRows: 1,
// 						widths: [30, '*', 100],
// 						body: tableBodyReturn,
// 					},
// 					layout: 'lightHorizontalLines',
// 					margin: [0, 0, 0, 20],
// 				},
// 				{
// 					text: 'O item acima foi recolhido e o servidor fica desonerado da responsabilidade sobre este bem a partir desta data.',
// 					style: 'legalText',
// 					margin: [0, 0, 0, 40],
// 				},
// 				{
...
// 			const tableBodyDelivery = [
// 				[
// 					{ text: 'QTD', style: 'tableHeader' },
// 					{ text: 'EQUIPAMENTO ENTREGUE', style: 'tableHeader' },
// 					{ text: 'PATRIMÔNIO', style: 'tableHeader' },
// 				],
// 			];
...
// 						{ text: '1', style: 'tableCell', alignment: 'center' },
// 						{
// 							text: `${a.item_type_name || ''} ${a.brand} ${a.model}`,
// 							style: 'tableCell',
// 						},
// 						{
// 							text: a.patrimonio_number || '-',
...
// 				getUserInfoBox(),
// 				{
// 					text: 'DESCRIÇÃO DOS EQUIPAMENTOS CEDIDOS (SUBSTITUIÇÃO)',
// 					style: 'sectionTitle',
// 					margin: [0, 10, 0, 2],
// 				},
// 				{
...
// 							bold: true,
// 						},
// 						'O objeto do presente contrato é permissão de uso, a título gratuito, dos equipamentos discriminados.',
// 					],
// 					style: 'clause',
// 				},
// 				{
...
// 							bold: true,
// 						},
// 						'São obrigações do (a) PERMISSIONÁRIO (A): a) conservar a coisa emprestada; b) não utilizar em destinação diversa; c) não ceder a terceiros; d) devolver o equipamento em bom estado.',
// 					],
// 					style: 'clause',
// 				},
// 				{
// 					text: [
// 						{
// 							text: 'CLÁUSULA TERCEIRA – DA RESPONSABILIDADE – ',
// 							bold: true,
// 						},
// 						'Em caso de roubo, furto ou extravio, apresentar B.O. em 48h.',
// 					],
// 					style: 'clause',
// 				},
// 				{
// 					text: 'E por estarem justos e contratados, assinam o presente termo.',
// 					margin: [0, 10, 0, 20],
// 					fontSize: 9,
// 				},
// 				{
...
// 						},
// 						{
// 							text: 'Gerência de Infraestrutura de Tecnologia - SGA',
// 							fontSize: 8,
// 							alignment: 'center',
// 							margin: [0, 5, 0, 0],
// 						},
...
// 			res.status(500).json({
// 				message:
// 					'Erro ao gerar o documento de prévia: ' + error.message,
// 			});
// 		}
// 	},
// );
...
// 	authenticateToken,
// 	authorizePermission('ACTION_REGISTER_MOVEMENT'),
// 	uploadSimple.single('receiptFile'),
// 	async (req, res) => {
// 		let {
// 			asset_ids,
// 			movement_type,
...
// 			}
// 		}
// 		if (typeof returned_peripherals === 'string') {
// 			try {
// 				returned_peripherals = JSON.parse(returned_peripherals);
// 			} catch (e) {
// 				returned_peripherals = [];
// 			}
// 		}
...
// 			try {
// 				asset_updates = JSON.parse(asset_updates);
// 			} catch (e) {
// 				asset_updates = {};
// 			}
...
// 			) ?
// 				parseInt(recipient_person_id)
// 			:	null;
// 		destination_unit_id =
// 			(
// 				destination_unit_id &&
// 				destination_unit_id !== 'null' &&
// 				destination_unit_id !== 'undefined'
// 			) ?
// 				parseInt(destination_unit_id)
// 			:	null;
...
// 					notes || null,
// 					destination_unit_id,
// 					request_channel_type || null,
// 					request_channel_details || null,
// 					deliveryStatus,
// 					receiptPath,
// 					actualDeliveryDate,
// 				],
...
// 					const newImei =
// 						imei !== undefined && imei.trim() !== '' ? imei.trim()
// 						: imei === '' ? null
// 						: undefined;
// 					const newSim =
// 						(
// 							sim_card_number !== undefined &&
// 							sim_card_number.trim() !== ''
// 						) ?
// 							sim_card_number.trim()
...
// 						newCurrentUnitId = destination_unit_id;
// 						break;
// 					case 'loan':
...
// 					case 'return':
// 						newAssetStatus =
// 							return_condition === 'defective' ? 'maintenance' : (
// 								'available'
// 							);
// 						const infraUnitRes = await client.query(
// 							`SELECT id FROM units WHERE name ILIKE '%Almoxarifado%' LIMIT 1`,
// 						);
// 						if (infraUnitRes.rows.length > 0)
// 							newCurrentUnitId = infraUnitRes.rows[0].id;
// 						break;
// 					case 'maintenance':
...
// 				await client.query(
// 					`UPDATE assets SET status = $1, current_unit_id = $2, updated_at = NOW() WHERE id = $3`,
// 					[newAssetStatus, newCurrentUnitId, asset_id],
// 				);
// 				await client.query(
// 					`INSERT INTO movement_assets (movement_id, asset_id) VALUES ($1, $2)`,
...
// 					if (pType)
// 						await client.query(
// 							`INSERT INTO movement_peripherals (movement_id, peripheral_type, quantity, status) VALUES ($1, $2, $3, 'out')`,
// 							[newMovementId, pType, pQty],
// 						);
// 				}
// 			}
// 			if (
...
// 				returned_peripherals &&
// 				Array.isArray(returned_peripherals)
// 			) {
// 				for (const p of returned_peripherals) {
// 					if (p.peripheral_type)
// 						await client.query(
// 							`INSERT INTO movement_peripherals (movement_id, peripheral_type, quantity, status) VALUES ($1, $2, $3, 'in')`,
// 							[newMovementId, p.peripheral_type, p.quantity],
// 						);
// 				}
// 			}
...
// 				'asset_movement',
// 				newMovementId,
// 				{ type: movement_type, assets: asset_ids },
// 				ipAddress,
// 			);
...
// 	authenticateToken,
// 	authorizePermission('ACTION_DELETE'),
// 	async (req, res) => {
// 		const { id } = req.params;
...
// 			return res
// 				.status(400)
// 				.json({ message: 'A nota de descarte é obrigatória.' });
// 		}
...
// 				throw new Error(
// 					`Apenas ativos com status 'Baixado' podem ser descartados. Status atual: ${asset.status}.`,
// 				);
// 			}
...
// 				'asset',
// 				id,
// 				{ disposal_note, old_status: asset.status },
// 				ipAddress,
// 			);
// 			res.status(200).json({
// 				message: 'Ativo descartado com sucesso!',
// 				asset: updatedAsset.rows[0],
// 			});
// 		} catch (error) {
// 			await client.query('ROLLBACK');
...
// 			res.status(500).json({
// 				message: `Erro ao descartar o ativo: ${error.message}`,
// 			});
// 		} finally {
// 			client.release();
// 		}
...
// 			if (!['available', 'maintenance'].includes(asset.status)) {
// 				throw new Error(
// 					`Ativos com status '${asset.status}' não podem ser baixados. É necessário primeiro registrar a devolução.`,
// 				);
// 			}
...
// 				'asset',
// 				id,
// 				{ reason, old_status: asset.status },
// 				ipAddress,
// 			);
// 			res.status(200).json({
// 				message: 'Ativo baixado com sucesso!',
// 				asset: updatedAsset.rows[0],
// 			});
// 		} catch (error) {
// 			await client.query('ROLLBACK');
...
// 			res.status(500).json({
// 				message: `Erro ao dar baixa no ativo: ${error.message}`,
// 			});
// 		} finally {
// 			client.release();
// 		}
...
// 		cb(
// 			null,
// 			'substituicao-' + uniqueSuffix + path.extname(file.originalname),
// 		);
// 	},
// });
...
// // =====================================================================
// app.post(
// 	'/api/asset-movements/substitute',
// 	authenticateToken,
// 	authorizeRole(['admin', 'manager']),
...
// 			return res.status(400).json({
// 				message:
// 					'É necessário selecionar os ativos antigos e os novos.',
// 			});
// 		}
...
// 			receiptPath ? 'confirmed' : 'pending_confirmation';
...
// 						console.log(
// 							`[SUBSTITUIÇÃO] Arquivo renomeado para: ${newFileName}`,
// 						);
// 					}
// 				} catch (renameError) {
// 					console.error(
// 						'Erro ao renomear arquivo de substituição:',
// 						renameError,
// 					);
...
// 						recipient_person_id = hist.recipient_person_id;
// 					if (!destination_unit_id)
// 						destination_unit_id = hist.destination_unit_id;
// 				}
// 			}

// 			if (!recipient_person_id)
// 				throw new Error(
// 					'Responsável pela substituição não identificado.',
// 				);

// 			// Busca ID do Almoxarifado para devolução dos antigos
// 			const warehouseUnitRes = await client.query(
// 				`SELECT id FROM units WHERE name ILIKE '%Almoxarifado%' LIMIT 1`,
// 			);
// 			const warehouseUnitId =
// 				warehouseUnitRes.rows.length > 0 ?
// 					warehouseUnitRes.rows[0].id
// 				:	null;

// 			// 5. REGISTRAR DEVOLUÇÃO (Recolhimento dos Antigos)
// 			// Se marcou "Com Defeito", vai pra manutenção. Se não, disponível.
// 			const oldAssetStatus =
// 				return_condition === 'defective' ? 'maintenance' : 'available';
...
// 				await client.query(
// 					'UPDATE assets SET status = $1, current_unit_id = $2, updated_at = NOW() WHERE id = $3',
// 					[oldAssetStatus, warehouseUnitId, oldAssetId],
// 				);
// 				await client.query(
// 					'INSERT INTO movement_assets (movement_id, asset_id) VALUES ($1, $2)',
// 					[returnMovementId, oldAssetId],
// 				);
// 			}
...
// 				await client.query(
// 					'UPDATE assets SET status = $1, current_unit_id = $2, updated_at = NOW() WHERE id = $3',
// 					[newAssetStatus, destination_unit_id, newAssetId],
// 				);
// 				await client.query(
// 					'INSERT INTO movement_assets (movement_id, asset_id) VALUES ($1, $2)',
// 					[exitMovementId, newAssetId],
// 				);
// 			}
...
// 					const pQty =
// 						typeof p === 'object' && p.quantity ? p.quantity : 1;

// 					if (pType) {
// 						await client.query(
// 							`INSERT INTO movement_peripherals (movement_id, peripheral_type, quantity, status) VALUES ($1, $2, $3, 'out')`,
// 							[exitMovementId, pType, pQty],
// 						);
// 					}
// 				}
// 			}
...
// 			res.status(500).json({
// 				message: 'Erro ao processar substituição: ' + error.message,
// 			});
// 		} finally {
// 			client.release();
// 		}
...
// // =====================================================================
// app.get(
// 	'/api/asset-movements/in-use-assets',
// 	authenticateToken,
// 	async (req, res) => {
// 		const { solicitante, patrimonio, startDate, endDate, itemType } =
// 			req.query;
...
// 			}
// 			if (patrimonio) {
// 				conditions.push(`a.patrimonio_number ILIKE $${paramIndex++}`);
// 				values.push(`%${patrimonio}%`);
// 			}
// 			if (itemType) {
// 				conditions.push(`it.name ILIKE $${paramIndex++}`);
// 				values.push(`%${itemType}%`);
// 			}
// 			if (startDate) {
// 				conditions.push(`am.movement_date >= $${paramIndex++}`);
...
// 						recipient_person_registration:
// 							row.recipient_person_registration,
...
// app.post(
// 	'/api/asset-movements/:id/confirm-delivery',
...
// 			return res
// 				.status(400)
// 				.json({ message: 'O arquivo do recibo é obrigatório.' });
// 		}
...
// 			return res
// 				.status(400)
// 				.json({ message: 'A data de entrega efetiva é obrigatória.' });
// 		}
...
// 			const movementResult = await client.query(
// 				'SELECT * FROM asset_movements WHERE id = $1',
// 				[id],
// 			);
// 			if (movementResult.rows.length === 0) {
...
// 				throw new Error(
// 					`Apenas movimentações com status 'pending_confirmation' podem ser confirmadas. Status atual: ${movement.delivery_status}`,
// 				);
// 			}
...
// 			);
// 			res.status(500).json({
// 				message: `Erro ao confirmar entrega: ${errorMessage}`,
// 			});
// 		} finally {
// 			client.release();
// 		}
...
// 			return res
// 				.status(400)
// 				.json({ message: 'A nova data de devolução é obrigatória.' });
// 		}
...
// 				throw new Error(
// 					'Apenas movimentações do tipo "empréstimo" podem ser renovadas.',
// 				);
// 			}
...
// 				'asset_movement',
// 				id,
// 				{ new_expected_return_date, renewal_note },
// 				ipAddress,
// 			);
// 			res.status(200).json({
...
// 			res.status(500).json({
// 				message: `Erro ao renovar empréstimo: ${error.message}`,
// 			});
// 		} finally {
// 			client.release();
// 		}
...
// // =====================================================================
// app.get(
// 	'/api/asset-movements/active-loans',
// 	authenticateToken,
// 	async (req, res) => {
// 		const { solicitante, patrimonio, startDate, endDate, itemType } =
// 			req.query;
...
// app.get(
// 	'/api/asset-movements/pending-delivery',
// 	authenticateToken,
// 	async (req, res) => {
...
// app.get(
// 	'/api/asset-movements/by-person/:personId',
// 	authenticateToken,
// 	async (req, res) => {
...
// 		} catch (error) {
// 			console.error(
// 				`Erro ao buscar movimentações da pessoa ${personId}:`,
// 				error,
// 			);
// 			res.status(500).json({ message: 'Erro interno do servidor.' });
// 		}
...
// app.get(
// 	'/api/asset-movements/by-asset/:assetId',
// 	authenticateToken,
// 	async (req, res) => {
...
// 		} catch (error) {
// 			console.error(
// 				`Erro ao buscar movimentações do ativo ${assetId}:`,
// 				error,
// 			);
// 			res.status(500).json({ message: 'Erro interno do servidor.' });
// 		}
...
// 		);
// 		res.status(500).json({
// 			message: 'Erro interno do servidor ao listar movimentações.',
// 		});
// 	}
// });
...
// 			return res.status(404).json({
// 				message:
// 					'Nenhuma movimentação encontrada com os filtros especificados.',
// 			});
// 		}
...
// 			content: [
// 				{
// 					text: 'Relatório de Movimentações Filtrado',
// 					style: 'header',
// 					alignment: 'center',
// 					margin: [0, 0, 0, 20],
// 				},
...
// 	const fullReportData = await Promise.all(
// 		movementsResult.rows.map(async (movement) => {
// 			const assetsResult = await pool.query(
...
// 					content: [
// 						{
// 							text: 'Nenhum empréstimo vencido encontrado no momento.',
// 							style: 'header',
// 							alignment: 'center',
// 						},
// 					],
// 					styles: {
// 						header: { fontSize: 18, bold: true, font: 'Roboto' },
// 					},
// 				};
// 				const pdfDocEmpty =
// 					printer.createPdfKitDocument(docDefinitionEmpty);
// 				res.header('Content-Type', 'application/pdf');
...
// 						},
// 						{
// 							text: 'Av. Oliveira Lima, 824 - Soledade | FONE: 3355-5471',
// 							alignment: 'center',
// 							fontSize: 8,
// 						},
// 					],
...
// 				content: [
// 					{
// 						text: 'Relatório de Empréstimos Vencidos',
// 						style: 'docTitle',
// 						alignment: 'center',
// 					},
// 					{
...
// 					},
// 					{
// 						text: `\nTotal de Empréstimos Vencidos: ${reportData.length}`,
// 						alignment: 'right',
// 						style: 'body',
// 						bold: true,
// 					},
...
// 			pdfDoc.on('end', () => {
// 				res.header('Content-Type', 'application/pdf')
// 					.attachment('relatorio_emprestimos_vencidos.pdf')
// 					.send(Buffer.concat(chunks));
// 				logAudit(
// 					req.user.id,
// 					'generate_report',
// 					'overdue_loans_report_pdf',
// 					null,
...
// 				return res
// 					.status(404)
// 					.json({ message: 'Nenhum empréstimo vencido encontrado.' });
...
// 			}
// 			res.header('Content-Type', 'text/csv; charset=utf-8')
// 				.attachment('relatorio_vencidos.csv')
// 				.send(csvRows.join('\n'));
// 		} catch (error) {
...
// app.get(
// 	'/api/reports/overdue-loans/xlsx',
// 	authenticateToken,
// 	async (req, res) => {
// 		try {
...
// 		).length;
// 		const maintenanceAssets = allAssets.filter((a) =>
// 			['maintenance', 'defective'].includes(a.status),
// 		).length;
// 		const inUseAssets = allAssets.filter(
// 			(a) => a.status === 'in_use',
// 		).length;
// 		const loanedAssets = allAssets.filter(
// 			(a) => a.status === 'loaned',
// 		).length;
...
// 			"SELECT COUNT(*) FROM asset_movements WHERE delivery_status = 'pending_confirmation'",
// 		);
// 		const pendingDeliveriesCount = parseInt(
// 			pendingDeliveriesRes.rows[0].count,
// 			10,
// 		);

// 		const pendingSubstitutionsRes = await pool.query(
// 			"SELECT COUNT(*) FROM pending_substitutions WHERE status = 'pending'",
// 		);
// 		const pendingSubstitutionsCount = parseInt(
// 			pendingSubstitutionsRes.rows[0].count,
// 			10,
// 		);
...
// 			else if (['in_use', 'loaned'].includes(a.status))
// 				statusLabel = 'Em Uso';
// 			else if (['maintenance', 'defective'].includes(a.status))
...
// 			else if (['maintenance', 'defective'].includes(a.status))
// 				statusBreakdown[catKey].maintenance++;

// 			// C. Formatação do Nome do Modelo
// 			const catNameStr = catKey.toLowerCase();
// 			let label = '';
// 			if (
// 				catNameStr.includes('tablet') ||
// 				catNameStr.includes('ipad') ||
// 				catNameStr.includes('galaxy') ||
// 				catNameStr.includes('tab')
// 			) {
// 				label = '📱 Tablet Padrão';
...
// 			} else {
// 				const brand =
// 					a.brand && a.brand.trim() ? a.brand.trim() : 'Sem Marca';
...
// 			breakdownMap[catKey][label] =
// 				(breakdownMap[catKey][label] || 0) + 1;

// 			// E. Contagem Avançada (Categoria -> Status -> Marca/Modelo)
// 			if (!advancedBreakdownMap[catKey])
// 				advancedBreakdownMap[catKey] = {};
// 			if (!advancedBreakdownMap[catKey][statusLabel])
// 				advancedBreakdownMap[catKey][statusLabel] = {};
// 			advancedBreakdownMap[catKey][statusLabel][label] =
// 				(advancedBreakdownMap[catKey][statusLabel][label] || 0) + 1;

// 			// F. Contagem Avançada GLOBAL (Sem Categoria -> Status -> Marca/Modelo)
// 			if (!advancedBreakdownMap['GLOBAL'][statusLabel])
// 				advancedBreakdownMap['GLOBAL'][statusLabel] = {};
// 			advancedBreakdownMap['GLOBAL'][statusLabel][label] =
// 				(advancedBreakdownMap['GLOBAL'][statusLabel][label] || 0) + 1;
// 		});
...
// 			assetsBreakdown[category] = Object.entries(models)
// 				.map(([name, value]) => ({ name, value }))
// 				.sort((a, b) => b.value - a.value);
// 		}
...
// 			recentMovementsResult.rows.map(async (m) => {
// 				const itemRes = await pool.query(
// 					`
//             SELECT it.name, a.brand, a.model FROM movement_assets ma 
//             JOIN assets a ON ma.asset_id = a.id 
//             JOIN item_types it ON a.item_type_id = it.id 
//             WHERE ma.movement_id = $1 LIMIT 1`,
// 					[m.id],
// 				);
...
// 			dueDate: new Date(row.expected_return_date).toLocaleDateString(
// 				'pt-BR',
// 			),
// 		}));
...
// app.get(
// 	'/api/asset-movements/:id/details',
// 	authenticateToken,
// 	async (req, res) => {
// 		const { id } = req.params;
// 		try {
...
// 		} catch (error) {
// 			console.error(
// 				`Erro ao buscar detalhes da movimentação ${id}:`,
// 				error,
// 			);
// 			res.status(500).json({ message: 'Erro interno do servidor.' });
// 		}
...
// // =====================================================================
// app.get(
// 	'/api/asset-movements/:id/receipt-pdf',
// 	authenticateToken,
// 	async (req, res) => {
// 		const { id } = req.params;
...
// 				requestSource = 'E-mail para relacionamentosepti@educ.rec.br';
// 			else if (movement.request_channel_type === 'SEI')
// 				requestSource = `Processo SEI Nº ${movement.request_channel_details || 'N/A'}`;
// 			else if (movement.request_channel_type === 'Ordem Direta')
// 				requestSource = `Ordem Direta de ${movement.request_channel_details || 'N/A'}`;
...
// 				receiptIntroText = [
// 					'Atestamos o ',
// 					{ text: 'RECEBIMENTO', bold: true },
// 					' do(s) equipamento(s) abaixo relacionado(s), que encontravam-se sob a guarda do servidor abaixo qualificado.',
...
// 						text: [
// 							'Declaro que ',
// 							{ text: 'DEVOLVI', bold: true },
// 							' à Gerência de Infraestrutura de Tecnologia - GIT, todos os equipamentos e acessórios constantes no recibo (verso), os quais foram conferidos pela equipe técnica.',
// 							'\n\n',
...
// 					case 'loan':
// 						receiptTitle = 'RECIBO DE EMPRÉSTIMO';
// 						break;
// 					case 'exit':
// 						receiptTitle = 'RECIBO DE ENTREGA';
// 						termTitle = 'TERMO DE ENTREGA';
// 						break;
// 					case 'maintenance':
// 						receiptTitle = 'GUIA DE MANUTENÇÃO';
// 						break;
// 				}
...
// 					{
// 						text:
// 							movement.destination_unit_name ||
...
// 					{
// 						text: [
// 							'Reconheço que recebi o(s) equipamento(s) descrito(s) no recibo constante no verso deste termo, por meio da Gerência de Infraestrutura de Tecnologia - GIT, a título de:\n\n',
// 							{
// 								text: `( X ) ${movementLabel}`,
// 								bold: true,
// 								fontSize: 11,
// 							},
// 						],
...
// 					},
// 					{
// 						text: '1. Caso o(s) equipamento(s) não esteja(m) tombado(s), me comprometo em facilitar o acesso do profissional do Setor de Patrimônio às instalações na qual o(s) equipamento(s) se encontrava(m).',
// 						style: 'legalText',
// 						margin: [0, 0, 0, 5],
// 					},
// 					{
// 						text: '2. Mediante rescisão de contrato, exoneração, aposentadoria ou transferência, comprometo-me a devolver à Gerência de Infraestrutura de Tecnologia - GIT, todos os equipamentos e acessórios que se encontrarem sob minha responsabilidade, que deverão estar completos e em bom estado de conservação e uso, considerando-se o tempo de obsolescência destes.',
// 						style: 'legalText',
// 						margin: [0, 0, 0, 5],
// 					},
// 					{
// 						text: '3. Comprometo-me a NÃO repassar a outra pessoa OU remanejar para outro departamento/setor o(s) equipamento(s) constante(s) neste recibo, sem a prévia autorização da GIT.',
// 						style: 'legalText',
// 						margin: [0, 0, 0, 5],
// 					},
// 					{
// 						text: '4. Estou ciente que se o(s) equipamento(s) for(em) extraviado(s), furtado(s) ou roubado(s), terei que tomar as providências URGENTES abaixo:',
// 						style: 'legalText',
// 						margin: [0, 0, 0, 2],
// 					},
// 					{
// 						text: ' 4.1 Registrar um Boletim de Ocorrência (B.O.) online ou na Delegacia de Polícia mais próxima do local em que ocorreu o fato. Neste B.O. Deverá constar as especificações do(s) equipamento(s) contendo número de TOMBO do patrimônio e número de SÉRIE.',
// 						style: 'legalText',
// 						margin: [10, 0, 0, 2],
// 					},
// 					{
// 						text: ' 4.2 Enviar um ofício citando o ocorrido com cópia anexa do Boletim de Ocorrência para a Gerência de Tecnologia, localizada à Av. Oliveira Lima, 824, Soledade, Recife (Prédio do CETEC) por e-mail (relacionamentosepti@educ.rec.br e dinfraestrutura@educ.rec.br).',
// 						style: 'legalText',
// 						margin: [10, 0, 0, 15],
// 					},
// 				];
...
// 						[
// 							{
// 								text: `NOME: ${movement.recipient_display_name || 'N/A'}`,
// 								style: 'infoBox',
// 							},
// 							{
// 								text: `CPF: ${movement.recipient_person_cpf || 'N/A'}`,
// 								style: 'infoBox',
// 							},
// 							{
// 								text: `MATRÍCULA: ${movement.recipient_person_registration || 'N/A'}`,
// 								style: 'infoBox',
// 							},
// 						],
// 						[
// 							{
// 								text: `UNIDADE: ${movement.destination_unit_name || 'N/A'}`,
// 								style: 'infoBox',
// 								colSpan: 3,
// 							},
// 							{},
...
// 				[
// 					{ text: 'QTD', style: 'tableHeader', alignment: 'center' },
// 					{ text: 'EQUIPAMENTO / ACESSÓRIO', style: 'tableHeader' },
// 					{
// 						text: 'SÉRIE',
// 						style: 'tableHeader',
// 						alignment: 'center',
...
// 			assets.forEach((a) => {
// 				const identificador =
// 					a.patrimonio_number ? a.patrimonio_number
// 					: a.sku ? `SKU: ${a.sku}`
// 					: '-';
...
// 					},
// 					{
// 						text: `Número do Recibo: ${movement.id}/${new Date(movement.movement_date).getFullYear()}`,
// 						alignment: 'right',
// 						fontSize: 9,
// 						margin: [0, 0, 0, 10],
// 					},
...
// 					{
// 						text: [
// 							{ text: 'Origem da Solicitação: ', bold: true },
// 							{ text: requestSource },
// 						],
// 						fontSize: 9,
// 						margin: [0, 0, 0, 15],
...
// 						text: [
// 							{
// 								text: `Total de Equipamentos: ${totalAssets}`,
// 								bold: true,
// 							},
// 							{
// 								text: `   |   Total de Acessórios: ${totalPeripherals}`,
// 								bold: true,
// 							},
// 						],
// 						fontSize: 10,
...
// 					},
// 					{
// 						text: `Recife, ${new Date(movement.movement_date).toLocaleDateString('pt-BR')}.`,
// 						alignment: 'center',
// 						margin: [0, 20, 0, 50],
// 						fontSize: 10,
// 					},
...
// 									},
// 									{
// 										text: 'Gerência de Infraestrutura Tecnologia',
// 										fontSize: 8,
// 										alignment: 'center',
// 									},
// 									{
// 										text: techActionLabel,
// 										fontSize: 8,
// 										alignment: 'center',
// 										italics: true,
// 									},
...
// 									{
// 										text:
// 											movement.recipient_display_name ||
// 											'Servidor',
// 										bold: true,
// 										fontSize: 9,
// 										alignment: 'center',
...
// 										text:
// 											(
// 												movement.recipient_person_registration
// 											) ?
...
// 					},
// 					{
// 						text: `Responsável: ${movement.recipient_display_name || ''}`,
// 						fontSize: 10,
// 						margin: [0, 0, 0, 5],
// 					},
// 					{
// 						text: `Cargo: ${movement.recipient_job_title || ''}`,
// 						fontSize: 10,
// 						margin: [0, 0, 0, 5],
// 					},
// 					{
// 						text: `Setor: ${movement.destination_unit_name || ''}`,
// 						fontSize: 10,
// 						margin: [0, 0, 0, 5],
// 					},
// 					{
// 						text: `Matrícula: ${movement.recipient_person_registration || ''}`,
// 						fontSize: 10,
// 						margin: [0, 0, 0, 5],
// 					},
// 					{
// 						text: `CPF: ${movement.recipient_person_cpf || ''}`,
// 						fontSize: 10,
// 						margin: [0, 0, 0, 30],
// 					},
// 					{
...
// 						color: '#444',
// 					},
// 					infoBox: { fontSize: 9, lineHeight: 1.3 },
...
// 			pdfDoc.on('end', () => {
// 				const namePart = (
// 					movement.recipient_display_name || 'Usuario'
// 				).replace(/[^a-zA-Z0-9]/g, '_');
// 				const datePart = new Date(movement.movement_date)
// 					.toLocaleDateString('pt-BR')
// 					.replace(/\//g, '-');
...
// 			console.error('Erro ao gerar recibo PDF:', error);
// 			res.status(500).json({
// 				message: 'Erro interno do servidor ao gerar recibo.',
// 			});
// 		}
// 	},
// );
...
// // =====================================================================
// app.get(
// 	'/api/reports/substitution-full/:returnId/:exitId',
// 	authenticateToken,
// 	async (req, res) => {
...
// 				return res.status(404).json({
// 					message: 'Dados da substituição não encontrados.',
// 				});
// 			}
...
// 						[
// 							{
// 								text: `NOME: ${data.recipient_display_name || 'N/A'}`,
// 								style: 'infoBox',
// 							},
// 							{
// 								text: `CPF: ${data.recipient_person_cpf || 'N/A'}`,
// 								style: 'infoBox',
// 							},
// 							{
// 								text: `MATRÍCULA: ${data.recipient_person_registration || 'N/A'}`,
// 								style: 'infoBox',
// 							},
// 						],
// 						[
// 							{
// 								text: `UNIDADE: ${data.destination_unit_name || 'N/A'}`,
// 								style: 'infoBox',
// 								colSpan: 3,
// 							},
// 							{},
...
// 				},
// 				{
// 					text: `Número do Recibo: ${dataReturn.movement.id}/${new Date(dataReturn.movement.movement_date).getFullYear()}`,
// 					alignment: 'right',
// 					fontSize: 9,
// 					margin: [0, 0, 0, 10],
// 				},
...
// 						dataReturn.movement.notes ?
// 							`Obs: ${dataReturn.movement.notes}`
// 						:	'',
// 					],
// 					style: 'body',
// 					margin: [0, 0, 0, 10],
...
// 				{
// 					text: 'O item acima foi recolhido para fins de substituição técnica e o servidor fica desonerado da responsabilidade sobre este bem específico a partir desta data.',
// 					style: 'legalText',
// 					margin: [0, 0, 0, 40],
// 				},

// 				{
// 					text: `Recife, ${new Date(dataReturn.movement.movement_date).toLocaleDateString('pt-BR')}.`,
// 					alignment: 'center',
// 					margin: [0, 0, 0, 40],
// 				},
...
// 					},
// 					{
// 						text: `Acessório: ${p.peripheral_type}`,
// 						style: 'tableCell',
// 						italics: true,
// 					},
// 					{ text: '-', style: 'tableCell', alignment: 'center' },
...
// 			const contentDelivery = [
// 				{
// 					text: 'RECIBO DE ENTREGA E TERMO DE RESPONSABILIDADE',
// 					style: 'docTitle',
// 					margin: [0, 0, 0, 10],
// 				},
// 				{
// 					text: `Número do Recibo: ${dataExit.movement.id}/${new Date(dataExit.movement.movement_date).getFullYear()}`,
// 					alignment: 'right',
// 					fontSize: 9,
// 					margin: [0, 0, 0, 10],
// 				},
...
// 						dataExit.movement.notes ?
// 							`Obs: ${dataExit.movement.notes}`
// 						:	'',
// 					],
// 					style: 'body',
// 					margin: [0, 0, 0, 10],
...
// 				{
// 					text: `Recife, ${new Date(dataExit.movement.movement_date).toLocaleDateString('pt-BR')}.`,
// 					alignment: 'center',
// 					margin: [0, 0, 0, 40],
// 				},
...
// 						},
// 						{
// 							text: 'Gerência de Infraestrutura de Tecnologia - Sistema SGA',
// 							fontSize: 8,
// 							alignment: 'center',
// 							margin: [0, 5, 0, 0],
// 						},
...
// 				res.header(
// 					'Content-Disposition',
// 					`inline; filename=Substituicao_${returnId}_${exitId}.pdf`,
// 				);
// 				res.send(Buffer.concat(chunks));
// 			});
// 			pdfDoc.end();
...
// // =====================================================================
// app.get(
// 	'/api/reports/management/inventory-by-unit/xlsx',
// 	authenticateToken,
// 	async (req, res) => {
// 		const ipAddress = req.ip;
// 		try {
...
// 				'SELECT id, name FROM item_types ORDER BY name ASC',
// 			);
...
// 			res.setHeader(
// 				'Content-Disposition',
// 				'attachment; filename=Inventario_Geral_Consolidado.xlsx',
// 			);
...
// // =====================================================================
// app.get(
// 	'/api/reports/management/movements-summary/xlsx',
// 	authenticateToken,
// 	async (req, res) => {
// 		const { startDate, endDate } = req.query;
...
// 					id: row.id,
// 					date:
// 						new Date(row.movement_date).toLocaleDateString(
// 							'pt-BR',
// 						) +
// 						' ' +
// 						new Date(row.movement_date).toLocaleTimeString(
// 							'pt-BR',
...
// 				{
// 					header: 'UNIDADE (DESTINO/ORIGEM)',
// 					key: 'origin_dest',
// 					width: 35,
// 				},
// 				{
// 					header: 'SOLICITANTE / BENEFICIÁRIO',
// 					key: 'person',
// 					width: 30,
// 				},
...
// // =====================================================================
// app.post(
// 	'/api/reports/preview-substitution-term',
// 	authenticateToken,
// 	async (req, res) => {
// 		try {
// 			const {
...
// 				try {
// 					rawPeriph = JSON.parse(rawPeriph);
// 				} catch (e) {}
// 			}
...
// 					periphList = Object.keys(rawPeriph).filter(
// 						(k) => rawPeriph[k] === true,
// 					);
// 				}
// 			}
...
// 						{ text: 'QTD', style: 'tableHeader', width: 25 },
// 						{
// 							text: 'EQUIPAMENTO / ACESSÓRIO',
// 							style: 'tableHeader',
// 							width: '*',
// 						},
// 						{ text: 'SÉRIE', style: 'tableHeader', width: 70 },
// 						{
// 							text: 'ID / PATRIMÔNIO / CHIP',
// 							style: 'tableHeader',
// 							width: 90,
// 						},
// 					],
...
// 				(assets || []).forEach((a) => {
// 					let desc =
// 						`${a.item_type_name || 'Equipamento'} ${a.brand || ''} ${a.model || ''}`.toUpperCase();
...
// 					text: [
// 						'Atestamos o ',
// 						{ text: 'RECOLHIMENTO', bold: true },
// 						' dos itens abaixo.\n',
// 						{ text: `Motivo: ${reason || '-'}`, italics: true },
// 					],
// 					style: 'infoBox',
// 					margin: [0, 0, 0, 5],
// 				},
...
// 						headerRows: 1,
// 						widths: [25, '*', 70, 90],
// 						body: buildTableRows(old_assets, false),
// 					},
// 					layout: 'lightHorizontalLines',
// 					margin: [0, 5, 0, 10],
// 				},
...
// 						},
// 						{
// 							text: 'Observações sobre o Estado de Conservação:',
// 							fontSize: 8,
// 							bold: true,
// 						},
// 						{
...
// 					[
// 						{
// 							text: 'Declaro a devolução do Chip/Sim Card acima identificado.',
// 							fontSize: 10,
// 							margin: [0, 20, 0, 20],
// 						},
// 					]
...
// 				getUserInfoBox(),
// 				{
// 					text: 'Estamos entregando o(s) item(ns) abaixo em substituição.',
// 					style: 'infoBox',
// 					margin: [0, 0, 0, 5],
// 				},
...
// 						headerRows: 1,
// 						widths: [25, '*', 70, 90],
// 						body: buildTableRows(new_assets, true),
// 					},
// 					layout: 'lightHorizontalLines',
// 					margin: [0, 5, 0, 10],
// 				},
...
// 						'Reconheço que recebi o(s) equipamento(s) descrito(s) no recibo constante no verso deste termo, por meio da Gerência de Infraestrutura de Tecnologia - GIT, a título de:\n\n',
// 						{
// 							text: '( X ) EMPRÉSTIMO / SUBSTITUIÇÃO',
// 							bold: true,
// 							fontSize: 10,
// 						},
// 					],
...
// 				},
// 				{
// 					text: '2. Mediante rescisão de contrato, exoneração, aposentadoria ou transferência, comprometo-me a devolver à Gerência de Infraestrutura de Tecnologia GIT, todos os equipamentos e acessórios que se encontrarem sob minha responsabilidade, que deverão estar completos e em bom estado de conservação e uso.',
// 					style: 'legalText',
// 				},
// 				{
// 					text: '3. Comprometo me a NÃO repassar a outra pessoa OU remanejar para outro departamento/ setor o(s) equipamento(s) constante(s) neste recibo, sem a prévia autorização da GIT.',
...
// 				},
// 				{
// 					text: '   4.1 Registrar um Boletim de Ocorrência (B.O.) online.',
// 					style: 'legalText',
// 					margin: [0, 2, 0, 2],
// 				},
// 				{
// 					text: '   4.2 Enviar ofício com B.O. para a Gerência de Tecnologia.',
// 					style: 'legalText',
// 					margin: [0, 2, 0, 15],
// 				},
...
// 		const mainOldId = parseId(
// 			Array.isArray(oldAssetIds) ? oldAssetIds[0] : oldAssetIds,
// 		);
// 		const mainNewId = parseId(
// 			Array.isArray(newAssetIds) ? newAssetIds[0] : newAssetIds,
// 		);
...
// 			return res.status(400).json({
// 				message: 'IDs dos ativos principais são obrigatórios.',
// 			});
// 		}
...
// 					typeCheck.rows[0].name.toUpperCase().includes('TABLET')
// 				) {
// 					await client.query(
// 						`
//                     UPDATE assets 
...
// 			await client.query(
// 				"UPDATE assets SET status = 'maintenance', notes = COALESCE(notes, '') || $1 WHERE id = $2",
// 				[lockNote, mainOldId],
// 			);
// 			await client.query(
// 				"UPDATE assets SET status = 'maintenance', notes = COALESCE(notes, '') || $1 WHERE id = $2",
...
// 			res.json({
// 				message: 'Substituição iniciada. Ativos travados.',
// 				pendingId: pendingId,
// 			});
// 		} catch (e) {
// 			await client.query('ROLLBACK');
// 			console.error(e);
// 			res.status(500).json({
// 				message: 'Erro ao salvar pendência: ' + e.message,
// 			});
// 		} finally {
// 			client.release();
// 		}
...
// 			const pendRes = await client.query(
// 				'SELECT * FROM pending_substitutions WHERE id = $1',
// 				[id],
// 			);
...
// 					whId,
// 					`Substituição Kit (Recolhido). Motivo: ${pend.reason}`,
// 				],
// 			);
...
// 			await client.query(
// 				'UPDATE assets SET status = $1, current_unit_id = $2 WHERE id = $3',
// 				[oldStatus, whId, pend.old_asset_id],
// 			);
// 			await client.query(
// 				'INSERT INTO movement_assets (movement_id, asset_id) VALUES ($1, $2)',
// 				[retMovId, pend.old_asset_id],
// 			);

// 			if (pend.old_monitor_id) {
// 				await client.query(
// 					'UPDATE assets SET status = $1, current_unit_id = $2 WHERE id = $3',
// 					[oldStatus, whId, pend.old_monitor_id],
// 				);
// 				await client.query(
// 					'INSERT INTO movement_assets (movement_id, asset_id) VALUES ($1, $2)',
// 					[retMovId, pend.old_monitor_id],
// 				);
// 			}
...
// 				originalType === 'exit' ? 'in_use' : 'loaned';

// 			// A. Vincula Novos Ativos
// 			await client.query(
// 				'UPDATE assets SET status = $1, current_unit_id = $2 WHERE id = $3',
// 				[newAssetStatus, pend.destination_unit_id, pend.new_asset_id],
// 			);
// 			await client.query(
// 				'INSERT INTO movement_assets (movement_id, asset_id) VALUES ($1, $2)',
// 				[exitMovId, pend.new_asset_id],
// 			);
...
// 				console.log(
// 					`[SUBSTITUIÇÃO] Migrando ${remnantAssets.length} ativos remanescentes para o movimento #${exitMovId}`,
// 				);
...
// 			await client.query(
// 				"UPDATE pending_substitutions SET status = 'completed' WHERE id = $1",
// 				[id],
// 			);

// 			await client.query('COMMIT');
// 			res.json({
// 				message: 'Substituição finalizada! Kit atualizado e unificado.',
// 			});
// 		} catch (e) {
// 			await client.query('ROLLBACK');
// 			console.error(e);
...
// 								},
// 								{
// 									text: 'SECRETARIA DE EDUCAÇÃO - GIT',
// 									bold: true,
// 									fontSize: 10,
// 								},
// 								{
// 									text: 'DIVISÃO DE INFRAESTRUTURA DE TECNOLOGIA',
// 									fontSize: 9,
// 								},
// 							],
// 							alignment: 'center',
...
// 				content: [
// 					{
// 						text: 'LAUDO TÉCNICO DE CONDENAÇÃO DE BEM',
// 						style: 'header',
// 						alignment: 'center',
// 						margin: [0, 10, 0, 20],
// 					},
...
// 								[
// 									{
// 										text: `Tipo de Item:\n${asset.item_type_name || 'Equipamento'}`,
// 										style: 'cell',
// 										colSpan: 3,
// 									},
// 									{},
...
// 					{
// 						text: 'Após análise técnica minuciosa, constatou-se que o equipamento acima descrito encontra-se IMPRÓPRIO para uso na rede municipal de ensino devido a:',
// 						fontSize: 10,
// 						margin: [0, 5, 0, 5],
// 					},
// 					{
...
// 					},
// 					{
// 						text: 'Diante do exposto, sugerimos a BAIXA PATRIMONIAL do referido bem, visto que sua recuperação é técnica ou economicamente inviável (Antieconômico/Irrecuperável).',
// 						fontSize: 10,
// 						margin: [0, 10, 0, 30],
// 						alignment: 'justify',
// 					},
...
// 							},
// 							{
// 								text: technician_name || 'Técnico Responsável',
// 								bold: true,
// 								alignment: 'center',
// 								fontSize: 10,
// 							},
// 							{
// 								text: 'Avaliador Técnico - GIT',
// 								fontSize: 9,
// 								alignment: 'center',
// 							},
// 						],
...
// 		} catch (error) {
// 			res.status(500).json({
// 				message: 'Erro ao gerar Laudo: ' + error.message,
// 			});
// 		}
// 	},
// );
...
// 			content: [
// 				{
// 					text: 'TERMO DE DESCARTE / DESTINAÇÃO FINAL',
// 					style: 'header',
// 					alignment: 'center',
// 					margin: [0, 10, 0, 20],
// 				},
...
// 				{
// 					text: 'Certificamos que o bem patrimonial abaixo descrito, previamente avaliado e baixado do acervo ativo (status: "Retired"), recebeu a seguinte destinação final:',
// 					fontSize: 10,
// 					margin: [0, 0, 0, 15],
// 					alignment: 'justify',
// 				},
...
// 							[
// 								{
// 									text: asset.patrimonio_number || 'S/N',
// 									alignment: 'center',
// 									bold: true,
// 								},
// 								{
// 									text: `${asset.item_type_name || ''} ${asset.brand} ${asset.model}`,
// 									alignment: 'center',
// 								},
// 								{
...
// 				{
// 					text: 'Declaro que o processo de descarte seguiu as normas ambientais e administrativas vigentes, não restando pendências sobre este item no estoque da Secretaria.',
// 					fontSize: 10,
// 					margin: [0, 10, 0, 30],
// 					alignment: 'justify',
// 				},
...
// 	} catch (error) {
// 		res.status(500).json({
// 			message: 'Erro ao gerar Termo: ' + error.message,
// 		});
// 	}
// });
...
// 			content: [
// 				{
// 					text: 'TERMO DE DESCARTE E DESTINAÇÃO FINAL (LOTE)',
// 					style: 'header',
// 					alignment: 'center',
// 					margin: [0, 10, 0, 20],
// 				},
...
// 				{
// 					text: `Certificamos que os ${assets.length} itens abaixo relacionados, previamente baixados do acervo ativo (Status: Retired), foram conferidos e receberam a seguinte destinação final física:`,
// 					fontSize: 10,
// 					margin: [0, 0, 0, 15],
// 					alignment: 'justify',
// 				},
...
// 				{
// 					text: 'Declaro que o processo seguiu as normas ambientais e administrativas vigentes, sendo os itens removidos fisicamente do estoque desta Secretaria.',
// 					fontSize: 10,
// 					margin: [0, 10, 0, 30],
// 					alignment: 'justify',
// 				},
...
// 					{ text: 'QTD', style: 'th' },
// 					{
// 						text: 'DESCRIÇÃO DO MATERIAL / EQUIPAMENTO',
// 						style: 'th',
// 					},
// 					{ text: 'OBSERVAÇÕES', style: 'th' },
// 				],
// 			];
...
// 				content: [
// 					{
// 						text: 'TERMO DE DESCARTE DE BENS INSERVÍVEIS (NÃO PATRIMONIADOS)',
// 						style: 'header',
// 						alignment: 'center',
// 						margin: [0, 10, 0, 20],
// 					},
...
// 					{
// 						text: `Certificamos a destinação final dos itens abaixo relacionados, classificados como sucata eletrônica ou bens inservíveis sem registro patrimonial ativo:`,
// 						fontSize: 10,
// 						margin: [0, 0, 0, 15],
// 						alignment: 'justify',
// 					},
...
// 					{
// 						text: disposal_destination.toUpperCase(),
// 						style: 'reasonBox',
// 					},
...
// 							},
// 							{
// 								text: technician_name || 'Responsável',
// 								bold: true,
// 								alignment: 'center',
// 								fontSize: 10,
// 							},
...
// 			return res.status(400).json({
// 				message:
// 					'O arquivo de evidência (laudo/B.O.) é obrigatório para o lote.',
// 			});
...
// 			return res
// 				.status(400)
// 				.json({ message: 'Formato de IDs inválido.' });
// 		}
...
// 			return res
// 				.status(400)
// 				.json({ message: 'Nenhum ativo selecionado.' });
// 		}
...
// 				throw new Error(
// 					'Nenhum dos ativos selecionados estava disponível para solicitação de baixa (verifique se já estão baixados ou em uso).',
// 				);
// 			}
...
// 			await logAudit(
// 				requesterUserId,
// 				'batch_request_retirement',
// 				'assets',
// 				null,
// 				{ count: processedIds.length, ids: processedIds },
// 				ipAddress,
// 			);
...
// // =====================================================================
// app.post(
// 	'/api/reports/batch-retirement-term-draft',
// 	authenticateToken,
// 	async (req, res) => {
// 		try {
// 			const { assetIds, reason } = req.body;
...
// 				content: [
// 					{
// 						text: 'SOLICITAÇÃO DE BAIXA PATRIMONIAL',
// 						style: 'header',
// 						alignment: 'center',
// 						margin: [0, 10, 0, 20],
// 					},
...
// 					{
// 						text: 'À Gerência de Infraestrutura de Tecnologia,',
// 						fontSize: 10,
// 						margin: [0, 0, 0, 10],
// 						bold: true,
// 					},
...
// 							{
// 								text: 'Laudo Técnico Individual físico',
// 								bold: true,
// 							},
...
// 					{
// 						text: 'RELAÇÃO DE ITENS PARA BAIXA:',
// 						style: 'sectionTitle',
// 					},
...
// 					{
// 						text: `Justificativa do Lote: ${reason.toUpperCase()}`,
// 						fontSize: 10,
// 						margin: [0, 10, 0, 10],
// 					},
...
// // =====================================================================
// app.post(
// 	'/api/retirement-requests/batch-action',
// 	authenticateToken,
// 	authorizePermission('ACTION_APPROVE_REJECT'),
// 	async (req, res) => {
...
// 			return res
// 				.status(400)
// 				.json({ message: 'Nenhuma solicitação selecionada.' });
...
// 				`SELECT id, asset_id, status FROM retirement_requests WHERE id = ANY($1::int[])`,
// 				[requestIds],
// 			);
// 			const validRequests = requestsRes.rows.filter(
// 				(r) => r.status === 'pending',
// 			);

// 			if (validRequests.length === 0)
// 				throw new Error(
// 					'Nenhuma solicitação pendente encontrada nos IDs informados.',
// 				);
...
// 				await client.query(
// 					`UPDATE assets SET status = 'retired', updated_at = NOW() WHERE id = ANY($1::int[])`,
// 					[assetIds],
// 				);
// 				// Atualiza Requests -> approved
// 				await client.query(
// 					`UPDATE retirement_requests SET status = 'approved', approver_user_id = $1, approval_date = NOW() WHERE id = ANY($2::int[])`,
// 					[adminId, validRequestIds],
// 				);
// 			} else {
// 				// Rejeitar
// 				// Atualiza Assets -> available
// 				await client.query(
// 					`UPDATE assets SET status = 'available', updated_at = NOW() WHERE id = ANY($1::int[])`,
// 					[assetIds],
// 				);
// 				// Atualiza Requests -> rejected
// 				await client.query(
// 					`UPDATE retirement_requests SET status = 'rejected', approver_user_id = $1, approval_date = NOW(), rejection_reason = $2 WHERE id = ANY($3::int[])`,
// 					[
// 						adminId,
// 						rejection_reason || 'Rejeitado em lote',
// 						validRequestIds,
// 					],
// 				);
// 			}
...
// 			await client.query('COMMIT');
// 			res.json({
// 				message: `Sucesso! ${validRequests.length} solicitações processadas.`,
// 			});
// 		} catch (error) {
// 			await client.query('ROLLBACK');
// 			res.status(500).json({ message: error.message });
...
// 			return res
// 				.status(400)
// 				.json({ message: 'Formato de itens inválido.' });
// 		}
...
// 			return res
// 				.status(400)
// 				.json({ message: 'A lista de itens está vazia.' });
// 		}
...
// 			);
// 			const schoolName =
// 				schoolRes.rows[0]?.name || 'Escola Não Identificada';
...
// 				const pat =
// 					item.patrimonio ?
// 						String(item.patrimonio).trim().toUpperCase()
// 					:	null;
// 				const serial =
// 					item.serial ?
...
// 				let sim =
// 					item.sim_card ?
// 						String(item.sim_card).replace(/\D/g, '')
// 					:	null;
...
// 					:	defaultTabletId;
// 				const brand =
// 					item.brand ? String(item.brand).toUpperCase() : 'GENERICO';
// 				const model =
// 					item.model ? String(item.model).toUpperCase() : 'LEGADO';

// 				// Define status físico (Controle de Estoque)
// 				const status =
// 					item.condition === 'Ruim' || item.condition === 'Defeito' ?
// 						'maintenance'
// 					:	'available';
...
// 						warnings.push(
// 							`Item ${pat || serial}: Chip ${sim} ignorado (pertence a ${conflictRes.rows[0].patrimonio_number}).`,
// 						);
// 						sim = null;
// 						stats.sim_conflicts++;
// 					}
...
//                     RETURNING id`,
// 						[
// 							pat || `S/PAT-${Math.floor(Math.random() * 10000)}`,
// 							serial || 'S/N',
// 							itemTypeId,
// 							sku,
// 							brand,
...
// 				const typeCheckSync = await client.query(
// 					'SELECT name FROM item_types WHERE id = $1',
// 					[currentItemTypeId],
// 				);
// 				const isTablet = typeCheckSync.rows[0]?.name
// 					.toUpperCase()
// 					.includes('TABLET');
...
// 						console.log(
// 							`[SYNC] Tablet ID ${assetId} desvinculado de aluno(s) via Coleta.`,
// 						);
// 					}
// 				}
// 				// =================================================================
...
// 				'asset_movement',
// 				movementId,
// 				{ stats, warnings, receipt_path: receiptPath },
// 				ipAddress,
// 			);
...
// 			const tabletRes = await client.query(
// 				'SELECT recipient_person_id, current_unit_id FROM assets WHERE id = $1',
// 				[id],
// 			);
...
// 				throw new Error('Tablet antigo não encontrado.');
...
// 			else {
// 				if (!new_tablet_code)
// 					throw new Error('Patrimônio do novo tablet é obrigatório.');

// 				// A. Busca Novo Tablet
// 				const newRes = await client.query(
// 					'SELECT * FROM assets WHERE patrimonio_number = $1 OR serial_number = $1',
// 					[new_tablet_code],
// 				);
...
// 				if (newTablet.status !== 'available')
// 					throw new Error(
// 						`O novo tablet não está disponível (Status: ${newTablet.status}).`,
// 					);

// 				// B. Define dados do Novo
// 				let finalSimNumber =
// 					scope === 'tablet_only' ?
// 						oldTablet.sim_card_number
// 					:	new_sim_number;
...
// 				const almoxRes = await client.query(
// 					"SELECT id FROM units WHERE name ILIKE '%Almoxarifado%' OR name ILIKE '%Manutenção%' LIMIT 1",
// 				);
// 				const maintenanceUnitId =
// 					almoxRes.rows[0]?.id || destination_unit_id;
...
// 					recipient_person_id || oldTablet.recipient_person_id;
// 				const targetUnit =
// 					destination_unit_id || oldTablet.current_unit_id;
...
// 			'SELECT name, type, code FROM units WHERE id = $1',
// 			[id],
// 		);
...
// 			...currentInventory.map((i) => i.item_type),
// 			...flowItems.map((i) => i.item_type),
// 		]);

// 		const stats = Array.from(allTypes).map((type) => {
// 			const inventoryOfType = currentInventory.filter(
// 				(i) => i.item_type === type,
// 			);
...
// 			const currentActiveLoans = inventoryOfType.filter(
// 				(i) => i.origin_type === 'loan',
// 			).length;
...
// 			const today = new Date();
// 			today.setHours(0, 0, 0, 0);
// 			const overdueCount = inventoryOfType.filter(
// 				(i) =>
// 					i.origin_type === 'loan' &&
// 					i.expected_return_date &&
// 					new Date(i.expected_return_date) <= today,
// 			).length;

// 			// D. Devolvidos (Dedução)
// 			const inventoryIds = new Set(inventoryOfType.map((i) => i.id));
// 			const returnedItemsList = flowOfType.filter(
// 				(f) => !inventoryIds.has(f.asset_id),
// 			);
// 			const uniqueReturned = [];
// 			const seenRet = new Set();
// 			returnedItemsList.forEach((item) => {
// 				if (!seenRet.has(item.asset_id)) {
// 					seenRet.add(item.asset_id);
// 					uniqueReturned.push(item);
// 				}
// 			});
...
// 				total_loans: flowOfType.filter(
// 					(f) => f.movement_type === 'loan',
// 				).length,
// 				total_exits: flowOfType.filter(
// 					(f) => f.movement_type === 'exit',
// 				).length,
...
// 				_details: {
// 					loans: inventoryOfType.filter(
// 						(i) => i.origin_type === 'loan',
// 					),
// 					exits: inventoryOfType.filter(
// 						(i) => i.origin_type !== 'loan',
// 					),
...
// 					type:
// 						item.movement_type === 'loan' ? 'EMPRÉSTIMO' : 'SAÍDA',
// 					tech: item.tech_name,
...
// 				'Relatorio_Pendencias_Docs.xlsx',
// 				columns,
// 				rows,
// 			);
// 		} catch (error) {
...
// // =====================================================================
// app.get(
// 	'/api/asset-movements/:id/signed-receipt',
// 	authenticateToken,
// 	async (req, res) => {
// 		const { id } = req.params;
...
// 			if (!fullPath) {
// 				return res.status(404).json({
// 					message: 'Nenhum arquivo anexado a esta movimentação.',
// 				});
// 			}
...
// 				return res.status(404).json({
// 					message:
// 						'O arquivo consta no banco mas não foi encontrado no disco.',
// 				});
// 			}
...
// 	authorizePermission('MENU_ESCOLAR'),
// 	async (req, res) => {
// 		const { school_unit_id, technician_name, reason, estimated_quantity } =
// 			req.body;

// 		if (!school_unit_id)
// 			return res
// 				.status(400)
// 				.json({ message: 'A unidade escolar é obrigatória.' });
...
// 			return res
// 				.status(404)
// 				.json({ message: 'Ordem de Coleta não encontrada.' });
// 		}

// 		const or = result.rows[0];
// 		if (or.status === 'completed') {
// 			return res.status(409).json({
// 				message: `Esta Ordem de Coleta já foi processada em ${new Date(or.completed_at).toLocaleDateString()}.`,
// 			});
// 		}
...
// // VERSÃO DEFINITIVA (Isolamento de Curvas e Correção de Variáveis)
// // =====================================================================
// app.get(
// 	'/api/analytics/tablet-projection',
// 	authenticateToken,
// 	async (req, res) => {
// 		try {
// 			const client = await pool.connect();
...
// 					'SELECT COUNT(*) as count FROM tablet_eligible_students',
// 				);
...
// 					const totalRecent = parseInt(
// 						runRateRes.rows[0].total_delivered,
// 						10,
// 					);
// 					const activeDays = parseInt(
// 						runRateRes.rows[0].active_days,
// 						10,
// 					);
// 					if (activeDays > 0) {
...
// 					);
// 					const calendarDaysNeeded = Math.ceil(
// 						workingDaysNeeded * (7 / 5),
// 					);
// 					projectedDate = new Date();
// 					projectedDate.setDate(
// 						projectedDate.getDate() + calendarDaysNeeded,
// 					);
// 				}
...
// 					cumulative += w.count;
// 					const label = w.weekStart.toLocaleDateString('pt-BR', {
// 						day: '2-digit',
// 						month: '2-digit',
// 					});
...
// 					let ideal =
// 						totalProjectTime > 0 ?
// 							Math.round((elapsed / totalProjectTime) * totalMeta)
// 						:	0;
...
// 					const endChartDate =
// 						projectedDate && projectedDate > targetDate ?
// 							projectedDate
// 						:	targetDate;

// 					while (
// 						futureDate < endChartDate ||
// 						futureCumulative < totalMeta
// 					) {
// 						futureDate.setDate(futureDate.getDate() + 7);

// 						// 1. Projeção da Equipe (Amarela)
...
// 							const elapsed =
// 								futureDate.getTime() - startDate.getTime();
// 							ideal =
// 								totalProjectTime > 0 ?
// 									Math.round(
// 										(elapsed / totalProjectTime) *
// 											totalMeta,
// 									)
// 								:	0;
// 							ideal = Math.min(Math.max(ideal, 0), totalMeta);
...
// 						chartData.push({
// 							name: futureDate.toLocaleDateString('pt-BR', {
// 								day: '2-digit',
// 								month: '2-digit',
// 							}),
// 							realizado: null,
// 							projetado: futureCumulative,
// 							planejado: ideal, // Corta a linha quando passa de maio
// 						});

// 						if (chartData.length > 150) break; // Trava de segurança
// 					}
// 				}
...
//                 SELECT 
//                     COALESCE(s.rpa, 'Indefinido') as rpa, 
//                     COUNT(s.id) as total,
//                     COUNT(CASE WHEN dbi.delivery_status IN ('realizada', 'confirmed') THEN 1 END) as delivered
//                 FROM tablet_eligible_students s
//                 LEFT JOIN delivery_batch_items dbi ON s.id = dbi.eligible_student_id
...
// 					name:
// 						r.rpa === 'Indefinido' ? 'Sem RPA'
// 						: String(r.rpa).toUpperCase().includes('RPA') ? r.rpa
// 						: `RPA ${r.rpa}`,
// 					entregues: parseInt(r.delivered, 10),
// 					pendentes: Math.max(
// 						0,
// 						parseInt(r.total, 10) - parseInt(r.delivered, 10),
// 					),
...
// 					weeklyVelocity,
// 					projectedDate:
// 						projectedDate ? projectedDate.toISOString() : null, // <<< AQUI OCORRIA O ERRO! AGORA CORRIGIDO.
